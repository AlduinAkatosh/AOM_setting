...
[
    ...
    (neg|ge, reg2, 8),
    (store_random_in_range, ":var_100", 0, 8),
    (eq, ":var_100", 0),
],
[
    (set_spawn_radius, 1),
    (store_add, ":var_0", "p_town_18", 1),
    (store_random_in_range, ":var_1", "p_town_1", ":var_0"),
    (spawn_around_party, ":var_1", "pt_manhunters"),
]),
  ...
  (0.2, 0.0, 0.0,
   [
       ...
       (else_try),
         ...
         (else_try),
           (call_script, "script_change_troop_faction", ":quest_object_troop", "fac_outlaws_robber_knight"),
         (try_end),
