...
from module_mission_templates_AoM import *
from module_mission_templates_multiplayer import *
...
#-----------------------------------------------------------------
  ...
  (
   ...
   [
     ...
     (try_begin), 
#       (this_or_next|eq, ":dead_agent_troop_no", "trp_powell_archer"),
#       (this_or_next|eq, ":dead_agent_troop_no", "trp_yishith_jungleslaughterer"),
#       (this_or_next|eq, ":dead_agent_troop_no", "trp_kouruto_therianthropy_tulwar_rider"),
#       (this_or_next|eq, ":dead_agent_troop_no", "trp_diemer_guardian"),
#       (this_or_next|eq, ":dead_agent_troop_no", "trp_papal_godward"),
#       (this_or_next|eq, ":dead_agent_troop_no", "trp_longshu_eagle_ruishi"),
#       (this_or_next|eq, ":dead_agent_troop_no", "trp_starkhook_berserker_worrior"),
      (eq, ":dead_agent_troop_no", "trp_citizen_pauper"),
          
       (eq, ":killer_agent_troop_no", "trp_player"),
          
       (display_message, "@You got keys of dungeon."),#监狱守卫
     (try_end),
   ]),     
  ]),
  ...
  (
    ...
    AoM_battle_triggers + [
      ...
      (ti_tab_pressed, 0, 0, [
                              (try_begin),
                                 (gt, "$g_mission_allow_leave", 0),
                                 (display_message, "@现 在 不 能 离 开 。 "),
                              (try_end),
                              (le, "$g_mission_allow_leave", 0),#不允许离开
                              (try_begin),
  ...
  (
    ...
    [(0,mtef_scene_source|mtef_team_0, af_override_horse, aif_start_alarmed, 1, pilgrim_disguise),
     ...
     (2,mtef_scene_source|mtef_team_0,af_override_horse,0,1,[]),
     (3,mtef_scene_source|mtef_team_0,af_override_horse,0,1,[]),
     (4,mtef_visitor_source|mtef_team_1, af_override_horse, aif_start_alarmed, 1, []),#敌方
     (5,mtef_scene_source|mtef_team_0,af_override_horse,0,1,[]),
     (6,mtef_scene_source|mtef_team_0,af_override_horse,0,1,[]),
     (7,mtef_scene_source|mtef_team_0,af_override_horse,0,1,[]),
     ...
     (11,mtef_visitor_source|mtef_team_1,af_override_horse,aif_start_alarmed,1,[]),#敌方
     (12,mtef_visitor_source,af_override_horse,0,1,[]),(13,mtef_scene_source,0,0,1,[]),(14,mtef_scene_source,0,0,1,[]),(15,mtef_scene_source,0,0,1,[]),
     (16,mtef_visitor_source,af_override_horse,0,1,[]),(17,mtef_visitor_source,af_override_horse,0,1,[]),(18,mtef_visitor_source,af_override_horse,0,1,[]),(19,mtef_visitor_source,af_override_horse,0,1,[]),(20,mtef_visitor_source,af_override_horse,0,1,[]),(21,mtef_visitor_source,af_override_horse,0,1,[]),(22,mtef_visitor_source,af_override_horse,0,1,[]),(23,mtef_visitor_source,af_override_horse,0,1,[]),
     (24,mtef_visitor_source,af_override_horse,0,1,[]),(25,mtef_visitor_source,af_override_horse,0,1,[]),(26,mtef_visitor_source,af_override_horse,0,1,[]),
     (27,mtef_visitor_source|mtef_team_1,af_override_horse,aif_start_alarmed,1,[]),#敌方
     (28,mtef_visitor_source|mtef_team_1,af_override_horse,aif_start_alarmed,1,[]),#敌方
    ...
    AoM_battle_triggers + [
      (ti_on_agent_spawn, 0, 0, [],
       [
         ...
         (eq, "$g_current_event", event_assassination),#刺杀
         (assign, "$mission_boss_1", ":agent_no"),
         ]),

      (ti_after_mission_start, 0, 0, [
         (assign, "$protect_agent_no", -1),#清空
         (eq, "$g_current_event", event_noble_assassinated),#贵族被刺杀
       ],
       [
         (try_begin),
         ...
         (else_try),
            (entry_point_get_position, pos10, 27),
         (try_end),
         (set_spawn_position, pos10),
         (spawn_agent, "trp_powell_nobility"),#刷出贵族
         (assign, "$protect_agent_no", reg0),
         (agent_set_team, "$protect_agent_no", 0),
         ]),
      ...
      (3, 4, ti_once,#战后处理
       [
         ...
         (else_try),
            (ge, "$protect_agent_no", 0),#保护模式
            (neg|agent_is_alive, "$protect_agent_no"),
            (assign, ":continue_no", 1),
         (try_end),
         (eq, ":continue_no", 1),
         ],
       [
         (try_begin),
            ...
            (try_begin),
               (main_hero_fallen),
               (display_message, "@强 盗 们 把 你 打 翻 在 地 ， 恶 狠 狠 地 补 上 几 十 脚 ， 直 到 你 满 身 鞋 印 ， 奄 奄 一 息 ， 作 为 你 胆 敢 反 抗 的 惩 罚 。 幸 运 的 是 ， 这 群 强 盗 并 不 想 闹 出 人 命 ， 但 你 的 钱 包 就 遭 殃 了 。 "),
               (troop_remove_gold, "trp_player", 1000),
            (else_try),
               (display_message, "@你 如 同 割 麦 子 一 般 干 掉 了 强 盗 ！ 你 再 次 孤 身 一 人 站 在 街 头 ， 周 围 散 布 着 强 盗 们 的 尸 体 。 搜 寻 尸 体 后 你 发 现 了 一 袋 钱 ， 或 许 是 他 们 的 赃 款 。 "),
         ...
         (else_try),
            ...
            (else_try),
               (display_message, "@你 给 了 刺 客 最 后 一 击 ， 但 你 还 是 觉 得 有 些 不 安 ， 好 像 正 在 被 无 数 双 眼 睛 盯 着 ， 却 又 看 不 到 人 。 意 识 到 刺 客 可 能 还 有 同 伙 ， 你 随 手 摸 走 其 身 上 的 一 些 东 西 作 为 战 利 品 ， 快 速 离 开 了 这 片 区 域 。 "),
               (try_begin),
                  (store_random_in_range, ":count_no", 0, 8),
                  (agent_get_item_slot, ":item_no", "$mission_boss_1", ":count_no"),
                  (gt, ":item_no", 0),
                  (neg|item_has_property, ":item_no", itp_unique),
                  (call_script, "script_troop_add_item_with_modifier_new", "trp_player", ":item_no", 0, 0, 0),
               (else_try),
         ...
         (else_try),
            ...
            (try_begin),
               ...
               (jump_to_menu, "mnu_death_end"),
            (else_try),
               (display_message, "@你 解 决 了 扑 上 来 的 打 手 ， 刚 想 结 果 那 两 个 头 目 ， 却 他 们 已 经 逃 之 夭 夭 了 。 虽 然 你 是 正 当 防 卫 ， 但 若 是 被 城 卫 队 逮 住 ， 他 们 可 能 会 动 用 手 段 来 整 你 。 多 一 事 不 如 少 一 事 ， 你 简 单 搜 刮 一 下 ， 溜 之 大 吉 。 "),
         ...
         (else_try),
            ...
            (try_begin),
               ...
               (jump_to_menu, "mnu_death_end"),
            (else_try),
               (ge, "$protect_agent_no", 0),
               (neg|agent_is_alive, "$protect_agent_no"),
               (display_message, "@你 保 护 的 对 象 倒 在 血 泊 中 ， 眼 见 是 不 活 了 。 刺 客 见 目 的 达 成 ， 不 再 恋 战 ， 虚 晃 一 招 便 溜 之 大 吉 ， 只 留 你 一 个 人 拔 剑 四 顾 心 茫 然 。 意 识 到 受 害 者 的 家 族 可 能 会 拿 你 顶 罪 ， 你 也 匆 忙 地 离 开 了 现 场 ， 只 留 一 地 狼 藉 。 "),
               (jump_to_menu, "mnu_center_new"), 
            (else_try),
               (display_message, "@你 们 取 得 了 胜 利 ！ 贵 族 青 年 对 你 表 示 感 谢 ， 将 他 身 上 所 有 的 现 金 送 给 了 你 ， 匆 忙 地 往 家 里 逃 去 了 。 "),
               (store_random_in_range, ":count_no", 1500, 2000),
               (troop_add_gold, "trp_player", ":count_no"),
               (call_script, "script_change_player_honor", 3),#荣誉提升
...
##          (agent_get_team, reg3, ":dead_agent_no"),          
      ...
      (0, 0, ti_once, [], [(assign,"$g_battle_won",0),
                           ...
                           (try_begin),
                               ...
                               (assign, "$g_defender_reinforcement_limit", 100),
                          (else_try),
...
#              ], []), #calculating and applying effect of people on others courage scores
      ...
      (try_for_agents, ":agent"),
          ...
          (neq, ":agent", "$mission_player_agent"),      
       ...
       [
        ...
        (try_for_range, ":guard_no", 0, ":num_guards"),
          ...
          (try_begin),
            ...
            (eq, ":guard_no", 2),
            (item_get_slot, ":troop_of_guard", ":center_culture", slot_culture_tier_2_troop), #潜行被发现时，从进城位置刷出一个兵来堵玩家
          (else_try),  
            (item_get_slot, ":troop_of_guard", ":center_culture", slot_culture_tier_5_troop),
          (try_end),
...
##        (mission_cam_set_animation, "anim_test_cam"),], []),
   ...
   (
    "auxiliary_training",0,-1,
    "You start training.",
    [
     (0,0,0,aif_start_alarmed,30,[]),
     (1,mtef_no_leader,0,0|aif_start_alarmed,5,[]),
#     (0,mtef_no_leader,0,0|aif_start_alarmed,0,[]),
     (3,mtef_enemy_party|mtef_reverse_order,0,aif_start_alarmed,30,[]),
     (4,mtef_enemy_party|mtef_reverse_order,0,aif_start_alarmed,0,[]),
     ],
    AoM_battle_triggers + [
#      (ti_before_mission_start, 0, 0, [], [(set_rain, 1,100), (set_fog_distance, 10)]),
    ...
    [
      ...
      (0, 0, 0, [(try_begin),
                 ...
                 (else_try),
                   ...
                   (reset_visitors),
                   (set_visitor,5,"trp_yishith_jungleslaughterer"),
                   (set_visitor,6,"trp_yishith_jungleslaughterer"),
                   (set_visitor,7,"trp_yishith_jungleslaughterer"),
...
##  ),
      ...
      (1, 0, ti_once, [],
	   ...
	   [          
          ...
          (else_try),
            ...
            (neq, ":random_value", 0),
            (assign, ":bandit_troop", "trp_cult_follower"),
          (try_end),
  ...
  (
    ...
    AoM_battle_triggers + [
      ...
      [              
        ...
        (try_begin),
          (agent_get_troop_id, ":troop_no", ":agent_no"),
          (is_between, ":troop_no", "trp_powell_merchant", "trp_startup_merchants_end"),
          (agent_set_team, ":agent_no", 7),          
          (team_set_relation, 0, 7, 0), 
        (try_end),                
      ]),
    ...
    AoM_battle_triggers + [
      ...
      [
        ...
        (try_begin),
          ...
          (try_begin),
              (eq,"$mozu_part_zero_weapon", 0),
              (agent_get_troop_id, ":agent_troop_id", ":dead_agent_no"),
              (eq,":agent_troop_id", "trp_fallen_warrior"),
              (troop_add_item, "trp_player","itm_mozu_changjian",imod_masterwork),
              (assign,"$mozu_part_zero_weapon", 1),
          (try_end),
        (else_try),
        ...
        (lt, "$merchant_sign_count", 8),
          ...
          (get_player_agent_no, ":player_agent"),
  	      (try_for_agents, ":agent_no"),
  	        ...
  	        (ge, ":agent_troop_id", "trp_powell_merchant"),
  ...
  (
    "undead_base_midul",0,-1,
    "Go to the undead base",
    [
      (0,mtef_visitor_source|mtef_team_0,0, 0,1,[]),
      (1,mtef_visitor_source|mtef_team_0,af_override_horse,0,1,[]),
      (2,mtef_visitor_source|mtef_team_0,af_override_horse,0,1,[]),
      ...
      (33,mtef_visitor_source|mtef_team_0,0,0,1,[]),
    ...
    AoM_battle_triggers + [
      ...
      [
         (try_for_agents, ":agent_no"),
             (agent_get_troop_id, ":troop_no", ":agent_no"),
             (eq, ":troop_no", "trp_reception"),
             (agent_get_position, pos1, ":agent_no"),
             (get_player_agent_no, ":play_agent_no"),
             (agent_get_position, pos2, ":play_agent_no"),
             ...
             (else_try),
                 (agent_clear_scripted_mode, ":agent_no"),
                 (start_mission_conversation,"trp_reception"),
             (try_end),
         (try_end),
      ]),
  ...
  (
    ...
    AoM_battle_triggers + [
      ...
      (1, 0, 3, [],   #ask player to leave
       [
         (try_for_agents, ":agent_no"),
            (agent_get_troop_id, ":troop_no", ":agent_no"),
            (eq, ":troop_no", "trp_cemetery_watcher"),
            (agent_get_position, pos1, ":agent_no"),
         (try_end),
         ...
         (gt, ":cur_distance", 5),
         (mission_enable_talk),
         (start_mission_conversation,"trp_cemetery_watcher"),
        ]),
  ...
  (
	"cemetery_night_fight",mtf_battle_mode ,charge,
    ...
    AoM_battle_triggers + [
      ...
      (0, 0, ti_once, [(eq, "$cemetery_travel", 1)],
       [
         (call_script, "script_music_set_situation_with_culture", mtf_sit_ambushed),
         (mission_disable_talk),
         (set_party_battle_mode),              	     
      ...
      (1, 0, 0, [(eq, "$cemetery_travel", 1)],
       ...
       (try_for_agents, ":agent_no"),
          (agent_get_troop_id, ":agent_troop_id", ":agent_no"),
          (try_begin),
             (eq, ":agent_troop_id", ":object_troop"),
             (neg|agent_is_alive, ":agent_no"),
             (assign, "$cemetery_travel", 2),
          (try_end),
          (try_begin),
             (eq, ":agent_troop_id", ":giver_troop"),
             (neg|agent_is_alive, ":agent_no"),
             (assign, "$cemetery_travel", 3),
          (try_end),
       (try_end),
       ]),
       ...
       (0, 0, ti_once,[
         (this_or_next|main_hero_fallen),
         (eq, "$cemetery_travel", 3),],#fail
       [
         (finish_mission),
         (change_screen_map),
         (call_script, "script_fail_quest", "qst_cemetery_travel"),
         (call_script, "script_end_quest", "qst_cemetery_travel"),
         (assign, "$cemetery_travel", 0), 
         ]),

       (3, 0, ti_once,[(eq, "$cemetery_travel", 2),],#win
       [
         (mission_enable_talk),
         (quest_get_slot, ":giver_troop", "qst_cemetery_travel", slot_quest_giver_troop),
         (start_mission_conversation,":giver_troop"),
      ...
      (ti_tab_pressed, 0, 0,
       [(eq, "$cemetery_travel", 4),
       ],
       [
        (finish_mission),
        (change_screen_return),
        (quest_get_slot, ":quest_giver_troop", "qst_cemetery_travel", slot_quest_giver_troop),
        (call_script, "script_change_player_relation_with_troop",":quest_giver_troop", 20),
        (call_script, "script_succeed_quest_new", "qst_cemetery_travel"),
        (call_script, "script_end_quest", "qst_cemetery_travel"),
        (assign, "$cemetery_travel", 0),
       ]),
  ...
  (
    ...
    [
      ...
      (2, mtef_visitor_source|mtef_team_0,af_override_everything,aif_start_alarmed,1,[itm_practice_staff,itm_practice_boots]),
      (3, mtef_visitor_source|mtef_team_0,af_override_everything,aif_start_alarmed,1,[itm_practice_staff,itm_practice_boots]),
      (4, mtef_visitor_source|mtef_team_0,af_override_everything,aif_start_alarmed,1,[itm_heavy_practice_sword,itm_practice_boots]),
      (5, mtef_visitor_source|mtef_team_1,0,aif_start_alarmed, 1,[]),
...
#         (assign, "$undead_test", 1),#lose
 ...
 #        (assign, "$undead_test", 2),#win
  ...
  (
    "infiltrate_necromancer_hidden_position",0,-1,
     "inflitrate into a necromancer hidden position.",
    [
      ...
      (44, mtef_visitor_source|mtef_team_2,af_override_horse,0,1,[]),
      ...
      (50, mtef_visitor_source|mtef_team_2,af_override_horse,0,1,[]),
    ],
    AoM_battle_triggers + AoM_inflitration_triggers + [
      #pos51 use for spawning
      #pos52 use for enemy target
      #pos53 use for enemy position right now
      #pos54 use for player position right now
      #pos55 use for the place where player is last vitnessed
  ...
  (
    ...
    AoM_battle_triggers + [
      ...
      [
       ...
       (store_trigger_param, ":item_drop", 2),
       (store_trigger_param, ":prop_drop", 3),
       (scene_prop_set_slot, ":prop_drop", slot_item_prop_item_no, ":item_drop"),
       (try_begin),
          (eq, ":agent_no", "$mission_player_agent"),
          (item_get_type, ":type_no", ":item_drop"),
          (try_begin),
             (neq, ":type_no", itp_type_shield),
             (neq, ":type_no", itp_type_bow),  #right hand
             (assign, ":slot_no", "$cur_weapon_right_hand"),
          (else_try),
             (assign, ":slot_no", "$cur_weapon_left_hand"),
          (try_end),
          (agent_set_slot, "$mission_player_agent", ":slot_no", 0),
          (val_add, ":slot_no", 6),
          (agent_get_slot, ":return_value", "$mission_player_agent", ":slot_no"),#ammo or shield hp
          (scene_prop_set_slot, ":prop_drop", slot_item_prop_hp_or_ammo, ":return_value"),
          (agent_set_slot, "$mission_player_agent", ":slot_no", 0),

          (val_add, ":slot_no", 6),
          (agent_get_slot, ":modifier_no", "$mission_player_agent", ":slot_no"),#item modifier
          (scene_prop_set_slot, ":prop_drop", slot_item_prop_modifier, ":modifier_no"),
          (agent_set_slot, "$mission_player_agent", ":slot_no", 0),
(display_message, "@a"),
       (try_end),
      ]),
      ...
      (0.5, 0, 0, [
       (assign, ":distance_max", 1),
       (assign, reg1, 0),
       (try_for_prop_instances, ":scene_prop_no"),
          (scene_prop_get_slot, ":item_seen", ":scene_prop_no", slot_item_prop_item_no),
          (gt, ":item_seen", 0),
          (agent_get_position, pos1, "$mission_player_agent"),
          (prop_instance_get_position, pos2, ":scene_prop_no"),
          (position_has_line_of_sight_to_position, pos1, pos2),
          (get_distance_between_positions_in_meters, ":distance_no", pos1, pos2),
          (lt, ":distance_no", ":distance_max"),
          (assign, ":distance_max", ":distance_no"),
          (assign, reg1, ":scene_prop_no"),
       (try_end),
       (gt, reg1, 0),],
...
#       (start_presentation, "prsnt_total_battle_interface"),
  ...
  (
    ...
    [
      ...
      (2, mtef_visitor_source|mtef_team_2,0,0,1,[]),
    ],
    AoM_battle_triggers + [
...
#       (assign, "$test_agent_no", ":agent_no"),
      ...
      (0, 0, 0,
       [(key_clicked, key_v),],
       [
#(agent_get_team, ":team_no", "$mission_player_agent"),
#        (agent_set_team, "$test_agent_no", ":team_no"),
#        (agent_set_animation, "$test_agent_no", "anim_walker_transforming"),
#        (display_message, "@Infected!"),
#        (agent_set_speed_modifier, "$test_agent_no", 30),
#(call_script, "script_activate_state", "$mission_player_agent", "itm_state_blurs", 1),
#            (agent_get_horse, ":agent_horse_no", "$test_agent_no"),
#            (agent_start_running_away, ":agent_horse_no"),
#        (agent_set_animation, "$test_agent_no", "anim_fantom_withdraw"),
       ]),

      (0, 0, 0, [(eq, 0, 1),],#test
      [
            (key_clicked, key_1),
            (agent_set_slot, "$mission_player_agent", slot_agent_state_caculate, 1),
               (agent_set_slot, "$mission_player_agent", slot_agent_state_count_1, 100),
         ]),
      (0, 0, 0, [(eq, 0, 1),],#test
      [
            (key_clicked, key_2),
(agent_get_horse, ":agent_horse_no", "$mission_player_agent"),
            (agent_set_slot, ":agent_horse_no", slot_agent_state_caculate, 1),
               (store_add, ":slot_no", 3, slot_agent_state_count_1),
               (agent_set_slot, ":agent_horse_no", ":slot_no", 40),
         ]),
...
#end of mission template
] + mission_templates_multiplayer + mission_templates_AoM
