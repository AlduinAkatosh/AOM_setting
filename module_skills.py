...
skills = [
  ...
  ("devout","Devout",sf_base_att_int,15,"strengthen religious sorceries."), 
  ("study","Study",sf_base_att_int,15,"Study sorceries."), 
  ("memory","Memory",sf_base_att_int,15, "The ability to memorize sorceries."), 
  ("array_arrangement","Array arrangement",sf_base_att_int,10,"anti-disturbing."), 
