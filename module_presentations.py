...
from module_presentations_multiplayer import *
from module_presentations_AoM import *
...
presentations = [
  ...
  ("game_custom_battle_designer_old", prsntf_manual_end_only, mesh_cb_ui_main, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (assign, ":cur_troop", "trp_powell_militia"),
      (else_try),
      ...
      (else_try),
        ...
        (assign, ":cur_troop", "trp_diemer_guardian"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_5"),
        (assign, ":cur_troop", "trp_godward_great_swordman"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_6"),
        (assign, ":cur_troop", "trp_longshu_shenwujun"),
      (else_try),
...
##      (overlay_set_size, "$g_presentation_obj_custom_battle_designer_5", pos1),
  ...
  ("name_auxiliary",0,mesh_load_window,[
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
        (str_store_string, s1, "str_name_auxiliary_text"),
        (create_text_overlay, reg1, s1, tf_center_justify),#title
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 500),
        (overlay_set_position, reg1, pos1),
        (overlay_set_text, reg1, s1),
        (create_simple_text_box_overlay, "$g_presentation_obj_name_auxiliary_1"),
        (position_set_x, pos1, 400),
        (position_set_y, pos1, 400),
        (overlay_set_position, "$g_presentation_obj_name_auxiliary_1", pos1),
        (str_store_troop_name, s0, "$g_talk_troop"),
        (overlay_set_text, "$g_presentation_obj_name_auxiliary_1", "str_default_auxiliary_name"),
        (str_store_string, s7, "str_default_auxiliary_name"),
        
        (create_button_overlay, "$g_presentation_obj_name_auxiliary_2", "@Continue...", tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 300),
        (overlay_set_position, "$g_presentation_obj_name_auxiliary_2", pos1),
        (presentation_set_duration, 999999),
        ]),
      (ti_on_presentation_event_state_change,
       [(store_trigger_param_1, ":object"),
        (try_begin),
          (eq, ":object", "$g_presentation_obj_name_auxiliary_1"),
          (str_store_string, s7, s0),
        (else_try),
          (eq, ":object", "$g_presentation_obj_name_auxiliary_2"),
...
##        (gt, ":total_wage", 0),
  ...
  ("faction_upgrade_trees", 0, 0, [
    (ti_on_presentation_load,
      [
        ...
        (try_for_range_backwards, ":i_upgrade_tree", 0, ":num_factions"),
          ...
          (else_try),
            (eq, ":faction_no", "fac_outlaws_integration"),
            (str_store_string, s0, "@Outlaws"),
          (else_try),
            (eq, ":faction_no", "fac_others_integration"),
        ...
        (try_for_range, ":cur_troop", soldiers_begin, soldiers_end),
          ...
          (gt, ":upgrade_troop", 0),
          # faction
          (assign, ":troop_dest_faction", "fac_others_integration"), # Default faction: Others
          ...
          (else_try),
            (is_between, ":cur_troop", "trp_looter", "trp_black_khergit_horseman"),
            (assign, ":troop_dest_faction", "fac_outlaws_integration"), # Outlaws
          (else_try),
          ...
          (try_for_range, ":loop_troop", soldiers_begin, ":end_cond"),
            ...
            # loop troop faction
            (assign, ":loop_troop_dest_faction", "fac_others_integration"), # Default faction: Others
            (store_troop_faction, ":loop_troop_faction", ":loop_troop"),
            (try_begin),
              (is_between, ":loop_troop", soldiers_begin, mercenary_troops_end),
              (assign, ":loop_troop_dest_faction", "fac_kingdoms_end"), # Mercenary
            (else_try),
              (eq, ":loop_troop_faction", "fac_outlaws"),
              (assign, ":loop_troop_dest_faction", "fac_outlaws_integration"), # Outlaws
            (else_try),
    ...
    (ti_on_presentation_event_state_change,
      ...
      ("world_map_new", 0, mesh_load_window, [
        (ti_on_presentation_load,
          [
            (presentation_set_duration, 999999),
            (set_fixed_point_multiplier, 1000),
            ...
            #move view
            (create_game_button_overlay, "$g_presentation_obj_3", "@Up"),
            (position_set_x, pos1, 900),
            (position_set_y, pos1, 275),
            (overlay_set_position, "$g_presentation_obj_3", pos1),
            (create_game_button_overlay, "$g_presentation_obj_4", "@Down"),
            (position_set_x, pos1, 900),
            (position_set_y, pos1, 225),
            (overlay_set_position, "$g_presentation_obj_4", pos1),
            (create_game_button_overlay, "$g_presentation_obj_5", "@Left"),
            (position_set_x, pos1, 900),
            (position_set_y, pos1, 175),
            (overlay_set_position, "$g_presentation_obj_5", pos1),
            (create_game_button_overlay, "$g_presentation_obj_6", "@Right"),
            (position_set_x, pos1, 900),
            (position_set_y, pos1, 125),
            (overlay_set_position, "$g_presentation_obj_6", pos1),
            (overlay_set_display, "$g_presentation_obj_3", "$map_size"),
            (overlay_set_display, "$g_presentation_obj_4", "$map_size"),
            (overlay_set_display, "$g_presentation_obj_5", "$map_size"),
            (overlay_set_display, "$g_presentation_obj_6", "$map_size"),

            #change size
            (create_game_button_overlay, "$g_presentation_obj_2", "@Amplify"),
            (position_set_x, pos1, 900),
            (position_set_y, pos1, 75),
            (overlay_set_position, "$g_presentation_obj_2", pos1),
            ...
            (assign, ":used_point", 0),
            (assign, "$center_num", 0),
            (store_add, ":max_x", "$amplify_x", 500),
            (store_add, ":max_y", "$amplify_y", 500),
            (assign, ":point_length", 1),

            (try_for_range, ":count_no", 0, 1000000),
               (store_div, ":cur_x", ":count_no", 1000),
               (store_mod, ":cur_y", ":count_no", 1000),

               (assign, ":continue", 0),
               (try_begin),
                  (eq, "$map_size", 0),#750*750
                  (val_mod, ":cur_x", 2),
                  (eq, ":cur_x", 0),
                  (val_mod, ":cur_y", 2),
                  (eq, ":cur_y", 0),
               ...
               (else_try),
                  (eq, "$map_size", 1),
                  (is_between, ":cur_x", "$amplify_x", ":max_x"),
                  (is_between, ":cur_y", "$amplify_y", ":max_y"),
                  (assign, ":continue", 1),
               (try_end),
               (eq, ":continue", 1),

               (store_div, ":pos_x", ":used_point", 500),
               (store_mod, ":pos_y", ":used_point", 500),

               #map color
               (troop_get_slot, ":compress_no", "trp_temp_array_new_map_2", ":count_no"),
               (store_mod, ":compress_no_1", ":compress_no", 10000),
               (store_div, ":compress_no_2", ":compress_no", 10000),
               (try_begin),
                  (eq, "$show_faction_map", 0),#natural
                  (this_or_next|eq, ":pos_y", 0),
                  (neg|ge, ":compress_no_1", 2),
                  (store_add, ":cur_x", ":pos_x", 250),
                  (store_add, ":cur_y", ":pos_y", 200),

                  (troop_get_slot, ":natural_color", "trp_temp_array_new_map_1", ":count_no"),#natrual
                  (create_mesh_overlay, reg0, "mesh_white_plane"),
                  (overlay_set_color, reg0, ":natural_color"),
                  ...
                  (assign, ":point_length", 1),
               (else_try),
                  (eq, "$show_faction_map", 1),#faction
                  (this_or_next|eq, ":pos_y", 0),
                  (neg|ge, ":compress_no_2", 2),
                  (store_add, ":cur_x", ":pos_x", 250),
                  (store_add, ":cur_y", ":pos_y", 200),

                  (troop_get_slot, ":natural_color", "trp_temp_array_new_map_6", ":count_no"),#faction
                  (create_mesh_overlay, reg0, "mesh_white_plane"),
                  (overlay_set_color, reg0, ":natural_color"),
                  (position_set_x, pos1, ":cur_x"),
                  (position_set_y, pos1, ":cur_y"),
                  ...
                  (assign, ":point_length", 1),
               (else_try),
                  (val_add, ":point_length", 1),
                  (store_mul, ":size_y", ":point_length", 50),
               ...
               #center button
               (try_begin),
                  (troop_get_slot, ":center_no", "trp_temp_array_new_map_3", ":count_no"),
                  (gt, ":center_no", 0),
                  (store_add, ":cur_x", ":pos_x", 250),
                  (store_add, ":cur_y", ":pos_y", 200),
                  (try_begin),
                     ...
                     (position_set_y, pos1, 150),
                     (overlay_set_size, reg1, pos1),
                     (overlay_set_display, reg1, "$show_town"),
                  (else_try),
                     ...
                     (position_set_y, pos1, 100),
                     (overlay_set_size, reg1, pos1),
                     (overlay_set_display, reg1, "$show_castle"),
                  (else_try),
                     ...
                     (position_set_y, pos1, 50),
                     (overlay_set_size, reg1, pos1),
                     (overlay_set_display, reg1, "$show_village"),
                  (try_end),
                  (position_set_x, pos1, ":cur_x"),
                  (position_set_y, pos1, ":cur_y"),
                  (overlay_set_position, reg1, pos1),
                  (overlay_set_color, reg1, 0),#black
 
                  (troop_set_slot, "trp_temp_array_new_map_8", "$center_num", reg1),#store overlay id
                  (troop_set_slot, "trp_temp_array_new_map_9", "$center_num", ":center_no"),#store center id
                  (val_add, "$center_num", 1),#store overlay number
               (try_end),

               (troop_set_slot, "trp_temp_array_new_map_4", ":used_point", ":count_no"),
               (val_add, ":used_point", 1),
           (try_end),

            #show centers
            (create_game_button_overlay, "$g_presentation_obj_7", "@Show towns"),
            (position_set_x, pos1, 900),
            (position_set_y, pos1, 425),
            (overlay_set_position, "$g_presentation_obj_7", pos1),
            (create_game_button_overlay, "$g_presentation_obj_8", "@Show castles"),
            (position_set_x, pos1, 900),
            (position_set_y, pos1, 375),
            (overlay_set_position, "$g_presentation_obj_8", pos1),
            (create_game_button_overlay, "$g_presentation_obj_9", "@Show villages"),
            (position_set_x, pos1, 900),
            (position_set_y, pos1, 325),
            (overlay_set_position, "$g_presentation_obj_9", pos1),

            (create_text_overlay, "$g_presentation_obj_10", "@_"),#center
            (position_set_x, pos1, 80),
            (position_set_y, pos1, 625),
            (overlay_set_position, "$g_presentation_obj_10", pos1),
            (create_text_overlay, "$g_presentation_obj_11", "@_"),#natural name
            (position_set_x, pos1, 80),
            (position_set_y, pos1, 575),
            (overlay_set_position, "$g_presentation_obj_11", pos1),

            (create_game_button_overlay, "$g_presentation_obj_12", "@nature faction change"),
            (position_set_x, pos1, 900),
      ...
      (ti_on_presentation_run,
       [
        ...
        (call_script, "script_mouse_fix_pos_run"),
         ...
         (position_get_x, ":cur_x", pos30),
         (position_get_y, ":cur_y", pos30),         
         (try_begin),
            (is_between, ":cur_x", 250, 750),
            (is_between, ":cur_y", 200, 700),
            (val_div, ":cur_x", 1),
            (val_div, ":cur_y", 1),
            (val_sub, ":cur_x", 250),
            (val_sub, ":cur_y", 200),
            (store_mul, ":count", ":cur_x", 500),
            (val_add, ":count", ":cur_y"),

            (troop_get_slot, ":point_no", "trp_temp_array_new_map_4", ":count"),
            (troop_get_slot, ":natural_party", "trp_temp_array_new_map_5", ":point_no"),
            (gt, reg0, 0),
            (str_store_party_name, s2, ":natural_party"),
            (overlay_set_text, "$g_presentation_obj_11", s2),
         (try_end),
        ]),
      ...
      (ti_on_presentation_mouse_enter_leave,
       [
         ...
         (eq, ":enter_leave", 0),
         (try_for_range, ":slot_no", 0, "$center_num"),
            (troop_slot_eq, "trp_temp_array_new_map_8", ":slot_no", ":object"),
            (troop_get_slot, ":center_no", "trp_temp_array_new_map_9", ":slot_no"),
            (str_store_party_name, s1, ":center_no"),
            (overlay_set_text, "$g_presentation_obj_10", s1),
         (try_end),
       ]),
      ...
      (ti_on_presentation_event_state_change,
       [
         ...
         (else_try),
            ...
            (lt, "$amplify_y", 500),
            (val_add, "$amplify_y", 125),
            (start_presentation, "prsnt_world_map_new"),
         (else_try),
            (eq, ":object", "$g_presentation_obj_4"),#down
            (gt, "$amplify_y", 0),
            (val_sub, "$amplify_y", 125),
            (start_presentation, "prsnt_world_map_new"),
         (else_try),
            (eq, ":object", "$g_presentation_obj_5"),#left
            (gt, "$amplify_x", 0),
            (val_sub, "$amplify_x", 125),
            (start_presentation, "prsnt_world_map_new"),
         (else_try),
            (eq, ":object", "$g_presentation_obj_6"),#right
            (lt, "$amplify_x", 500),
            (val_add, "$amplify_x", 125),
            (start_presentation, "prsnt_world_map_new"),
         (else_try),
            (eq, ":object", "$g_presentation_obj_7"),#town
            (val_sub, "$show_town", 1),
            (val_abs, "$show_town"),
            (try_for_range, ":slot_no", 0, "$center_num"),
               (troop_get_slot, ":center_no", "trp_temp_array_new_map_9", ":slot_no"),
               (is_between, ":center_no", towns_begin, towns_end),
               (troop_get_slot, ":cur_overlay", "trp_temp_array_new_map_8", ":slot_no"),
               (overlay_set_display, ":cur_overlay", "$show_town"),
            (try_end),
         (else_try),
            (eq, ":object", "$g_presentation_obj_8"),#castle
            (val_sub, "$show_castle", 1),
            (val_abs, "$show_castle"),
            (try_for_range, ":slot_no", 0, "$center_num"),
               (troop_get_slot, ":center_no", "trp_temp_array_new_map_9", ":slot_no"),
               (is_between, ":center_no", castles_begin, castles_end),
               (troop_get_slot, ":cur_overlay", "trp_temp_array_new_map_8", ":slot_no"),
               (overlay_set_display, ":cur_overlay", "$show_castle"),
            (try_end),
         (else_try),
            (eq, ":object", "$g_presentation_obj_9"),#village
            (val_sub, "$show_village", 1),
            (val_abs, "$show_village"),
            (try_for_range, ":slot_no", 0, "$center_num"),
               (troop_get_slot, ":center_no", "trp_temp_array_new_map_9", ":slot_no"),
               (is_between, ":center_no", villages_begin, villages_end),
               (troop_get_slot, ":cur_overlay", "trp_temp_array_new_map_8", ":slot_no"),
               (overlay_set_display, ":cur_overlay", "$show_village"),
            (try_end),
         (else_try),
            (eq, ":object", "$g_presentation_obj_12"),
            (val_sub, "$show_faction_map", 1),
            (val_abs, "$show_faction_map"),
            (start_presentation, "prsnt_world_map_new"),
         (try_end),
       ]),
   ]),
...
presentations = presentations + multiplayer_presentations + AoM_presentations