...
from module_game_menus_AoM import *
...
game_menus = [
  ("start_game_0",menu_text_color(0xFFFFFF)|mnf_disable_all_keys,#开局第一个界面（hard core，顺序不能改）
    "在 一 片 眩 目 的 光 芒 与 震 耳 欲 聋 的 轰 鸣 中 ， 时 空 的 帷 幕 悄 然 撕 裂 。 你 ， 一 个 灵 魂 的 旅 者 ， 发 现 自 己 悬 浮 于 异 世 的 虚 空 ， 俯 瞰 着 一 幕 静 谧 而 诡 异 的 场 景 。 ^这 是 一 间 舱 室 ， 空 气 中 弥 漫 着 尘 封 历 史 的 沉 重 与 死 亡 的 寂 静 。 七 具 身 着 奇 异 古 装 的 躯 体 ， 以 不 祥 的 姿 势 散 落 一 地 ， 仿 佛 被 时 间 遗 忘 的 棋 子 ， 静 待 着 命 运 的 下 一 步 。 ^一 股 神 秘 的 力 量 在 你 心 中 涌 动 ， 仿 佛 是 命 运 的 呼 唤 ， 又 似 是 时 空 的 馈 赠 。 你 意 识 到 ， 自 己 拥 有 着 不 可 思 议 的 能 力 — — 能 够 入 主 其 中 一 具 躯 体 。 作 为 一 段 未 知 旅 程 的 开 幕 ， 你 必 须 做 出 选 择 ， 是 选 择 那 身 着 坚 固 盔 甲 的 骑 士 ， 抑 或 是 那 手 持 古 卷 的 智 者 ？ ^^每 一 扇 门 后 都 隐 藏 着 不 同 的 故 事 与 挑 战 。 你 决 定 — —",
    "none",
...
#     (set_show_messages, 0),
    ...
    [
     ...
     ("test_pass",[],"测 试 通 道 。 ",
       [
#        (assign, "$faction_chossen", "itm_kingdom_1_2"),
...
(start_presentation, "prsnt_faction_window"),
  ...
  ("start_phase_2", mnf_disable_all_keys, #开局第二个hard core菜单，在捏完脸设置完属性之后弹出，从这个可以无缝衔接到大地图了。
    "船 舱 之 外 ， 阵 阵 剧 烈 的 爆 炸 声 与 撕 心 裂 肺 的 呼 喊 交 织 成 一 片 混 乱 的 海 洋 ， 空 气 中 弥 漫 着 死 亡 的 味 道 — — 一 场 突 如 其 来 的 袭 击 正 在 上 演 。 在 这 片 惊 心 动 魄 的 战 场 中 ， 屋 内 的 景 象 同 样 触 目 惊 心 ， 七 具 冰 冷 的 身 躯 零 乱 地 散 布 各 处 ， 他 们 的 生 命 早 已 在 袭 击 者 的 暴 行 下 戛 然 而 止 。 ^^而 对 于 你 来 说 ， 这 个 躯 壳 不 过 是 暂 时 的 栖 身 之 所 ， 一 次 不 可 思 议 的 借 尸 还 魂 让 你 得 以 窥 见 这 场 浩 劫 。 尽 管 如 此 ， 你 依 然 处 于 袭 击 者 的 眼 线 之 下 ， 成 为 了 他 们 誓 要 清 除 的 对 象 。 幸 运 的 是 ， 袭 击 者 可 能 并 未 察 觉 你 的 异 样 变 化 ， 误 以 为 此 处 已 无 生 还 之 人 。 ",
    "none",
    [
      (troop_clear_inventory, "trp_player"),
      (troop_get_inventory_capacity, ":inventroy_limit", "$character_choose"),
      (try_for_range, ":count_no", 0, ":inventroy_limit"),
         (troop_get_inventory_slot, ":item_no", "$character_choose", ":count_no"),#物品栏
         (gt, ":item_no", 0),
         (troop_get_inventory_slot_modifier, ":modifier_no", "$character_choose", ":count_no"),
         (val_add, ":modifier_no", "itm_imod_0"),
         (call_script, "script_player_add_and_equip_item_with_modifier_new", ":item_no", ":modifier_no", 0, 0),
      (try_end),
      (call_script, "script_troop_add_item_with_modifier_new", "trp_player", "itm_luxury_crown", 0, 0, 0),#倾国王冠
    ],
    [   
      ("set_inventory",[], "挣 扎 爬 起 ， 捡 起 装 备 。 ",
       [
         (set_show_messages, 1),
         (assign, "$g_starting_town", "p_libra_smuggle_wharf"),#权厄之秤走私码头
         (party_set_morale, "p_main_party", 100),
         (set_encountered_party, "p_libra_smuggle_wharf"),
         (jump_to_menu, "mnu_start_game_scene"),
       ]),
      ("never_mind",[], "摸 着 石 头 过 河 ， 测 试 通 道 。 ", #use for test
       [
         (set_show_messages, 1),
         (assign, "$g_starting_town", "p_town_34"),
         (party_set_morale, "p_main_party", 100),
  ...
  ("tutorial",mnf_disable_all_keys, #用于主菜单的训练
  ...
  (
    "start_game_3",mnf_disable_all_keys,#用于快速战斗？
    "选 择 剧 本 ： ",
    "none",
    [
...
#########以上全部都是系统调用的，不能动顺序，不过可以动内容。

  ("start_game_1",menu_text_color(0xFFFFFF)|mnf_disable_all_keys,#开局第二个界面，选择性别并切到加点捏脸面板
    "逐 渐 冰 冷 的 躯 体 慢 慢 恢 复 了 温 度 ， 似 乎 正 欢 欣 于 你 的 入 主 。 还 没 等 你 决 定 下 一 步 该 怎 么 做 ， 突 然 间 你 感 到 身 体 如 同 软 泥 般 蠕 动 起 来 — — 似 乎 ， 你 可 以 在 一 定 范 围 内 改 造 这 具 躯 体 ， 你 选 择 … …",
    "none",
    [(set_background_mesh, "mesh_undead_production_window"),],
    [
      ("start_male",[
         (neq, "$character_choose", "trp_quick_battle_troop_3"),#侍女
         (neq, "$character_choose", "trp_quick_battle_troop_7"),#公主
       ], "选 择 变 为 男 性 。 ",
       [
      ...
      ("start_pretty_female",[],"选 择 变 为 漂 亮 的 女 性 。 ",
       [
         (troop_set_type,"trp_player", tf_pretty_female),
         (assign,"$character_gender",tf_female),
         (change_screen_return, 0),
        ]),
      ("start_special_face",[],"debug ： 特 殊 面 部 。 ",
       [
         (troop_set_type, "trp_player", tf_special_female),
         (assign,"$character_gender",tf_female),
         (change_screen_return, 0),
        ]),
    ]
  ...
  ("start_game_scene", mnf_disable_all_keys,#开局所有涉及到的场景都集成在这里。
    "{s1}",
    "none",
    [
       (try_begin),
          (lt, "$current_startup_quest_phase", 1),
          (str_store_string, s1, "@趁 着 这 短 暂 的 平 静 期 ， 你 可 以 在 房 间 内 从 容 不 迫 地 搜 寻 任 何 可 用 之 物 。 "),
       (else_try),
          (eq, "$current_startup_quest_phase", 2),
          (str_store_string, s1, "@难 以 想 象 的 伟 力 一 击 便 摧 毁 了 整 条 船 只 ， 在 你 反 应 过 来 之 前 ， 就 与 所 有 的 活 人 死 人 一 起 落 入 冰 冷 的 海 水 中 。 还 没 等 你 扑 腾 两 下 ， 一 块 从 天 而 降 的 木 板 正 中 你 的 脑 门 ， 你 昏 了 过 去 。 ^^然 而 ， 预 料 之 中 的 第 二 次 死 亡 并 没 有 降 临 。 再 次 醒 来 时 ， 你 正 躺 在 一 处 海 港 的 隐 蔽 角 落 。 海 港 上 堆 满 了 货 物 ， 还 有 佩 戴 武 器 的 人 来 来 往 往 。 你 把 呼 救 的 话 吞 进 了 肚 子 — — 这 些 人 绝 非 善 类 。 "),
       (else_try),
          (eq, "$current_startup_quest_phase", 3),
          (call_script, "script_troop_add_item_with_modifier_new", "trp_player", "itm_courser", 0, 0, 0),
          (str_store_string, s1, "@你 成 功 逃 离 了 走 私 码 头 ， 还 幸 运 地 找 到 了 一 匹 马 。 不 过 他 们 提 到 的 地 牢 让 你 有 些 在 意 。 不 管 怎 么 说 ， 现 在 最 重 要 的 是 找 个 地 方 休 息 ， 恢 复 一 番 后 ， 再 做 打 算 。 "),
       (else_try),
          (eq, "$current_startup_quest_phase", 4),
          (str_store_string, s1, "@你 像 垃 圾 一 样 被 扔 了 出 来 ！ 走 私 者 们 以 为 你 是 跑 进 来 偷 东 西 的 乞 丐 ， 甚 至 不 屑 于 取 你 的 命 ， 对 你 身 上 的 破 烂 货 也 看 不 上 眼 ， 不 过 一 个 手 贱 的 顺 走 了 你 的 护 符 。 无 论 如 何 ， 你 活 下 来 了 。 "),
       (else_try),
          (ge, "$current_startup_quest_phase", 5),
          (str_store_string, s1, "@你 你 趴 在 港 口 附 近 的 山 丘 上 远 远 观 察 ， 码 头 上 的 武 装 人 员 加 强 了 戒 备 ， 如 果 硬 闯 ， 或 许 会 有 一 场 恶 战 ， 或 许 可 以 等 到 夜 晚 再 行 潜 入 ？ ^你 记 得 在 码 头 另 一 端 有 一 座 堡 垒 ， 那 里 或 许 就 是 你 的 目 标 。 "),
       (try_end),
    ],
    [
      ("observe_the_room",
       ...
       [
         (modify_visitors_at_site, "scn_sea_ship_room"),
         (reset_visitors),
         (set_visitor, 1, "trp_player"),

         (assign, ":count_no_2", 2),
         (try_for_range_backwards, ":count_no", 0, 7),
            (store_add, ":troop_no", ":count_no", "trp_quick_battle_troop_1"),
            (neq, ":troop_no", "$character_choose"),
            (set_visitor, ":count_no_2", ":troop_no"),
            (val_add, ":count_no_2", 1),
         (try_end),
         (set_jump_mission,"mt_ship_room"),
         (jump_to_scene,"scn_sea_ship_room"),
         (change_screen_mission),
       ]),
      ...
      ("go_to_the_board",
       ...
       [
         (try_begin),
            (player_has_item, "itm_highly_toxin"),
            (player_has_item, "itm_small_life_talisman"),#道具拿全了
            (assign, "$current_startup_quest_phase", 1),
         (else_try),
            (display_message, "@再 检 查 一 圈 吧 。 "),
         (try_end),
         (eq, "$current_startup_quest_phase", 1),

         (modify_visitors_at_site, "scn_sea_ship_attacked"),
         (reset_visitors),
         (set_visitor, 2, "trp_player"),
         (assign, "$boss_choose_1", "trp_starkhook_megalith_berserker"),
         (set_visitor, 4, "$boss_choose_1"),
         (set_visitor, 5, "trp_lesaff_armed_sailor"),
         (set_visitor, 6, "trp_dark_owl_eloise"),#暗枭埃洛伊斯
         (set_jump_mission,"mt_ship_attacked"),
         (jump_to_scene,"scn_sea_ship_attacked"),
         (change_screen_mission),
       ], "登 上 甲 板 "),
      ...
      ("libra_smuggle_wharf",
       ...
       [(call_script, "script_infitarte_into_libra_smuggle_wharf"),#权厄之秤走私码头
       ]),

      ("escape",
       [(is_between, "$current_startup_quest_phase", 3, 5),
       ],"逃 离 。 ",
       [
         (assign, "$infiltrate_tut", -1),#关闭潜行模式
         (party_relocate_near_party, "p_main_party", "p_libra_smuggle_wharf", 1),
         (change_screen_map),
         (assign, "$current_startup_quest_phase", 5),

         (str_store_party_name_link, s20, "p_town_4"),
         (str_store_string, s2, "@虽 然 对 走 私 者 们 提 到 的 地 牢 有 些 在 意 ， 但 你 此 时 也 只 是 个 其 身 难 保 的 异 乡 异 客 而 已 。 几 度 遭 遇 生 死 大 关 ， 现 在 的 你 需 要 休 息 — — 而 在 地 平 线 上 远 远 窥 见 的 巨 城 便 是 不 错 的 落 脚 处 。 ^前 往 {s20}。 "),
         (call_script, "script_start_quest", "qst_game_start_quest", -1),
        ]),

      ("libra_smuggle_wharf_2",
       [(eq, "$current_startup_quest_phase", 12),
       ],"潜 入 进 走 私 码 头 。 ",
       [(call_script, "script_infitarte_into_libra_smuggle_wharf_2"),#权厄之秤走私码头
       ]),

      ("libra_smuggle_wharf_stronghold",
       [#(ge, "$current_startup_quest_phase", 13),
(eq, 0, 1),
       ],"进 入 码 头 要 塞 。 ",
       [
         (try_begin),
            (lt, "$current_startup_quest_phase", 12),
            (display_message, "@门 锁 上 了 。 "),
         (else_try),
            (check_quest_active, "qst_game_start_quest"),#开局剧情：重回权厄之秤码头
            (eq, "$current_startup_quest_phase", 12),
            (modify_visitors_at_site, "scn_libra_smuggle_wharf_stronghold"),
            (reset_visitors),
            (set_visitor, 1, "trp_player"),
            (set_visitor, 2, "trp_libra_hitman"),#权厄之秤杀手
            (set_visitor, 3, "trp_npc4"),
            (set_jump_mission,"mt_libra_smuggle_wharf_stronghold"),
            (jump_to_scene,"scn_libra_smuggle_wharf_stronghold"),
            (change_screen_mission),
         (try_end),
       ], "码 头 要 塞 "),
  ...
  ("world_map",0,"{s1}","none",
    [    (str_store_string, s1, "@Choose one type."),],
    [
      ("world_map_1",[],"World map 1",
  ...
  ("faction_relations_report",0,
   ...
   [
    ...
    [
       ("orders", [],"View relations with Monster.",
    [(jump_to_menu, "mnu_monster_relations_report"),
    ]
       ),
  ...
  ("monster_relations_report",0,
   "{s1}",
   "none",
   [
    (str_clear, s2),
    (try_for_range, "$monster_relation", "fac_outlaws_libra", "fac_outlaws_deserters"),
      (faction_slot_eq, "$monster_relation", slot_faction_state, sfs_active),
      (neq, "$monster_relation", "fac_player_supporters_faction"),
      (store_relation, ":cur_relation", "fac_player_supporters_faction", "$monster_relation"),
      (try_begin),
        (ge, ":cur_relation", 90),
        (str_store_string, s3, "@Follow"),
      (else_try),
        (ge, ":cur_relation", 60),
        (str_store_string, s3, "@Help"),
      (else_try),
        (ge, ":cur_relation", 40),
        (str_store_string, s3, "@Support"),
      (else_try),
        (ge, ":cur_relation", 20),
        (str_store_string, s3, "@Friend"),
      (else_try),
        (ge, ":cur_relation", 10),
        (str_store_string, s3, "@Accepting"),
      (else_try),
      ...
      (else_try),
        (str_store_string, s3, "@Vengeful"),
      (try_end),
      (str_store_faction_name, s4, "$monster_relation"),
      (assign, reg1, ":cur_relation"),
      (str_store_string, s2, "@{!}{s2}^{s4}: {reg1} ({s3})"),
    (try_end),
    (str_store_string, s1, "@Your relation with the factions are:^{s2}"),
  ...
  ("camp",mnf_scale_picture,
   "You set up camp. What do you want to do?{s1}",
   "none",
   [
     ...
     (call_script, "script_get_natural_zone", ":map_x", ":map_y", ":current_terrain"), #获取自然环境名称
     (str_store_party_name, s1, reg0),
    ],
    [
      ("camp_action_1",[],"Walk around.", #到处走走
       [(set_jump_mission,"mt_ai_training"),
      ...
      ("god_finger",
       [], "God Finger!",
       [(call_script, "script_increase_necromancer_credits", 1000),
        ],
       ),
...
(start_presentation, "prsnt_faction_window"),
      ...
      ("test_weapon",
       [], "Test2!",
       [
#(call_script, "script_output_troop_itms_text","trp_player"),#获取装备，用于给兵种出装
#(try_for_range, ":party_no", "p_castle_4_1", "p_castle_5_1"),
#   (party_get_slot, ":troop_no", ":party_no", slot_town_lord),
#   (gt, ":troop_no", 0),
#   (str_store_troop_name, s1, ":troop_no"),
#   (str_store_party_name, s2, ":party_no"),
#   (display_message, "@{s1}_{s2}"),
#(try_end),
           (set_relation, "fac_kingdom_1", "fac_player_faction", 52),
           (set_relation, "fac_kingdom_1", "fac_player_supporters_faction", 52),
        ]),
  ...
  ("camp_action",0,
   ...
   [
    ...
    [
      ...
      ("camp_infinite_reinforcement_open",
       [(eq,"$g_infinite_reinforcement",0),
        ], "Infinite Reinforcement Mode : Close.",
       [(assign,"$g_infinite_reinforcement",1),
        ],
       ),

      ("camp_infinite_reinforcement_close",
       [(eq,"$g_infinite_reinforcement",1),
        ], "Infinite Reinforcement Mode : Open.",
       [(assign,"$g_infinite_reinforcement",0),
        ],
       ),
  ...
  ("camp_recruit_prisoners",0,
   ...
   [(assign, ":num_regular_prisoner_slots", 0),
    ...
    (try_for_range, ":cur_stack", 0, ":num_stacks"),
      ...
      (store_character_level, ":var_6", ":cur_troop_id"),
      (troop_get_slot,":var_7","trp_player", slot_troop_renown),
      (try_begin),
          (ge,":var_7",5000),
          (neg|ge, ":var_6", 50),
      (else_try),        
  ...
  ("camp_action_read_book",0,
   ...
   [],
    [
      ...
      ("action_read_book_8",[(player_has_item, "itm_book_necromancer_low"),
                             (item_slot_eq, "itm_book_necromancer_low", slot_item_book_read, 0),
                             (str_store_item_name, s1, "itm_book_necromancer_low"),
                             ],"{s1}.",
       [(assign, "$temp", "itm_book_necromancer_low"),
        (jump_to_menu, "mnu_camp_action_read_book_start"),
        ]
       ),
      ("action_read_book_9",[(player_has_item, "itm_book_necromancer_middle"),
                             (item_slot_eq, "itm_book_necromancer_middle", slot_item_book_read, 0),
                             (str_store_item_name, s1, "itm_book_necromancer_middle"),
                             ],"{s1}.",
       [(assign, "$temp", "itm_book_necromancer_middle"),
        (jump_to_menu, "mnu_camp_action_read_book_start"),
        ]
       ),
      ("action_read_book_10",[(player_has_item, "itm_book_necromancer_high"),
                             (item_slot_eq, "itm_book_necromancer_high", slot_item_book_read, 0),
                             (str_store_item_name, s1, "itm_book_necromancer_high"),
                             ],"{s1}.",
       [(assign, "$temp", "itm_book_necromancer_high"),
        (jump_to_menu, "mnu_camp_action_read_book_start"),
        ]
       ),
      ("camp_action_4",[],"Back to camp menu.",
 ...
 all your money, and ride off into the sunset....",
  ...
  ( #野战
    ...
    [      
        ...
        (try_begin),
          (eq, "$new_encounter", 1), #刚接触
          (assign, "$new_encounter", 0),
          (assign, "$g_encounter_is_in_village", 0),
          (assign, "$g_encounter_type", 0),
          (try_begin),
            (party_slot_eq, "$g_enemy_party", slot_party_ai_state, spai_raiding_around_center), #判断是不是烧村
            ...
            (try_begin),
              ...
              (assign, "$g_encounter_type", enctype_fighting_against_village_raid), #敌方AI为洗劫村庄，且在村庄周边一定范围内，哪怕没开始烧村，也会进入村子战斗
            (try_end),
          (try_end),
          (try_begin),
            ...
            (party_quick_attach_to_current_battle, "$g_encounter_is_in_village", 1), #玩家烧村被逮住，村庄守军加入战场与玩家敌对
            (str_store_string, s1, "@Villagers"),
            (display_message, "str_s1_joined_battle_enemy"),
          (else_try),
            (eq, "$g_encounter_type", enctype_fighting_against_village_raid),
            (party_quick_attach_to_current_battle, "$g_encounter_is_in_village", 0),  #玩家逮住正在烧村的领主，村庄守军加入战场成为玩家的盟友
            (str_store_string, s1, "@Villagers"),
            (display_message, "str_s1_joined_battle_friend"),
            # Let village party join battle at your side
          (try_end),
                    
          (call_script, "script_let_nearby_parties_join_current_battle", 0, 0), #将附近部队拉入战场
        ...
        (else_try), #第二轮以上
          (try_begin), #杀了一批人后才能撤退
            (eq, "$cant_leave_encounter", 1),
            (call_script, "script_party_count_members_with_full_health", "p_main_party_backup"), #战后统计的原部队，虚拟
            ...
            (store_sub, ":leave_encounter_limit", ":org_total_party_counts", 10), #至少要杀十个才能撤
        ...
        (try_end),
        (try_begin),
          (call_script, "script_party_count_members_with_full_health", "p_collective_enemy"), #统计归到p_collective_enemy里的敌方剩余部队人数
        ...
        (else_try),       
          (call_script, "script_party_count_members_with_full_health", "p_main_party"),  #统计玩家剩余部队人数      
    ...
    [
      ...
      ("change_auxiliary_name",#use for rename auxiliary
        [(party_is_active,"$g_encountered_party"),
    (party_slot_eq,"$g_encountered_party",slot_party_type, spt_attendant_party),
         ],
        "Change Auxiliary Name.",
        [(start_presentation, "prsnt_name_auxiliary"),          (party_set_extra_text,"$g_encountered_party", "@Auxiliary"),]),

#      ("walk_around_and_see_this_auxiliary",[(party_is_active,"$g_encountered_party"),
#    (party_slot_eq,"$g_encountered_party",slot_party_type, spt_attendant_party),],"Walk around.",
#       [(set_jump_mission,"mt_ai_training"),
#         (call_script, "script_setup_random_scene"),
#        (change_screen_mission),
#        ]
#       ),
      ("have_a_fight",[(party_is_active,"$g_encountered_party"),   #used for player assistant army
    (party_slot_eq,"$g_encountered_party",slot_party_type, spt_attendant_party), ],"Walk around.",
       [(set_jump_mission,"mt_auxiliary_training"),
        (call_script, "script_setup_random_scene"),
        (change_screen_mission),
        ]
       ),
...
#Troop commentary changes end
 ...
 but you'll have to leave {reg4} soldiers behind to stop the enemy from giving chase.",
  ...
  (
    ...
    "{s11}^^Your Casualties:{s8}{s10}^^Enemy Casualties:{s9}^^Get Corpse:{s13}",
    "none",
    [
     (try_begin),
       (eq, "$g_battle_result", 1),
        ...
        (else_try),
          ...
          (try_begin),
            ...
            (try_begin),
                ...
                (party_stack_get_troop_id, ":var_68", "p_encountered_party_backup", 0),
                (neg|is_between, ":var_68", "trp_npc1", "trp_knight_relatives_begin"),
                (store_faction_of_party, ":var_14", "$g_enemy_party"),
                (neg|is_between, ":var_14", "fac_neutral", "fac_player_faction"), #功能性阵营
                (call_script, "script_change_player_relation_with_faction", ":var_14", -4),
            (try_end),
            (leave_encounter),
            (change_screen_return),
          (else_try),            
      ...
      ("pre_join_help_attackers",[
        ...
        (try_end),
          ...
          "Move in to help the {s2}.",[
              ...
              (call_script, "script_change_player_relation_with_faction", ":var_0", -10),
...
#      ("zendar_leave",[],"Leave town.",[[leave_encounter],[change_screen_return]]),
  ...
  (
    "fiend_nest_1",mnf_auto_enter,
    "Attack the dungeons.",
    "none",
    [],
    [
      ("enter",[],"Enter.",[(set_jump_mission,"mt_town_default"),(jump_to_scene,"scn_fiend_nest_1"),(change_screen_mission)]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ),
  (
    "fiend_nest_2",mnf_auto_enter,
    "Attack the dungeons.",
    "none",
    [],
    [
      ("enter",[],"Enter.",[(set_jump_mission,"mt_town_default"),(jump_to_scene,"scn_fiend_nest_2"),(change_screen_mission)]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ),

  (
    "fiend_nest_3",mnf_auto_enter,
    "Attack the dungeons.",
    "none",
    [],
    [
      ("enter",[],"Enter.",[(set_jump_mission,"mt_town_default"),(jump_to_scene,"scn_fiend_nest_3"),(change_screen_mission)]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ),

  (
    "fiend_nest_4",mnf_auto_enter,
    "Attack the dungeons.",
    "none",
    [],
    [
      ("enter",[],"Enter.",[(set_jump_mission,"mt_town_default"),(jump_to_scene,"scn_fiend_nest_4"),(change_screen_mission)]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ),
...
#wait to be change
        ...
        (try_begin),
          ...
          (else_try),
            ...
            (set_background_mesh, "mesh_pic_mountain_bandits"),
          (else_try),
            (eq, ":bandit_troop", "trp_abyssal_sailor"),
            (set_background_mesh, "mesh_pic_sea_raiders"),
          (else_try),
            (set_background_mesh, "mesh_pic_bandits"),
          (try_end),
        ...
        (else_try),
          ...
          (try_begin),
            ...
            (             eq, ":cur_terrain", rt_desert_mountain),
    ...
    [
      ...
      (quest_get_slot, ":target_center", "qst_cemetery_travel", slot_quest_target_center),
     ...
     (try_begin),
         (is_currently_night),
         (display_message, "@cemetery at night is very dangerous."),
         (call_script, "script_cemetery_night_fight"),
     (else_try),
         (call_script, "script_cemetery_day"),
     (try_end),
      ],"Door to the cemetery"),

      ("village_hidden_position",
      [
      (neg|party_slot_eq, "$current_town", slot_village_state, svs_looted),
      (neg|party_slot_eq, "$current_town", slot_village_state, svs_being_raided),
      (neg|party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),

      (check_quest_active, "qst_destroy_results"),
      (quest_get_slot, ":target_center", "qst_destroy_results", slot_quest_target_center),
      (eq, ":target_center", "$current_town"),
      ],
      "sneak into the hidden position",
      [
      (call_script, "script_infitarte_into_necromancer_hidden_position"),
      ],"Door to the hidden position"),
...
#NPC companion changes end
  ...
  (
    ...
    "none",
    [    
#        (start_presentation, "prsnt_party_window_new"),

        (try_begin),        #music
          (eq, "$sneaked_into_town", 1),
          (call_script, "script_music_set_situation_with_culture", mtf_sit_town_infiltrate),   #sneak
        (else_try),
...
##        (else_try),
        ...
        (str_store_party_name, s2, "$current_town"),#获取城镇和领主名字备用
        (party_get_slot, ":center_lord", "$current_town", slot_town_lord),
        (store_faction_of_party, ":center_faction", "$current_town"),
        (str_store_faction_name, s9, ":center_faction"),
        (try_begin),
	 ...
	 #          (val_add, ":prosperity", 5),
        ...
        (try_begin),
          (party_slot_eq,"$current_town",slot_party_type, spt_castle),#城镇所属的描述语句
          (try_begin),
            (eq, ":center_lord", "trp_player"),
            (str_store_string,s11,"@ Your own banner flies over the castle gate."),
		  (else_try),
...
##            (str_store_string,s11,"@ The townsfolk here have declared their independence."),
        ...
        (try_begin), 
          ...
          (str_store_string, s13, "@ You have successfully sneaked in."),#潜入和宴会的描述语句
		(else_try),  
        ...
        #forbidden to enter?
        (try_begin), 
          (store_time_of_day,reg(12)),#夜晚的描述
          (ge,reg(12),5),
          (lt,reg(12),21),
          (assign,"$town_nighttime",0),
        (else_try),
        ...
        (try_begin),
          (party_slot_ge, "$current_town", slot_town_has_tournament, 1),#竞技大会
          (neg|is_currently_night),
		...
		(call_script, "script_set_town_picture"),#菜单背景图
      ...
      "Take a walk around the streets.",
       [
         ...
         (try_begin),
           ...
           (faction_get_slot, ":center_culture", ":town_faction", slot_faction_culture), #获取文化
           (item_get_slot, ":tier_2_troop", ":center_culture", slot_culture_tier_2_troop),
           (item_get_slot, ":tier_3_troop", ":center_culture", slot_culture_tier_3_troop),
           (item_get_slot, ":tier_4_troop", ":center_culture", slot_culture_tier_4_troop),
         ...
         (else_try),
           ...
           (try_begin),
             (neq, ":town_faction", "fac_player_supporters_faction"), #不属于玩家自立国家。用现文化
             (faction_get_slot, ":center_culture", ":town_faction", slot_faction_culture), #获取文化
             (item_get_slot, ":troop_prison_guard", ":center_culture", slot_culture_prison_guard_troop),
             (item_get_slot, ":troop_castle_guard", ":center_culture", slot_culture_castle_guard_troop),
             (item_get_slot, ":tier_2_troop", ":center_culture", slot_culture_tier_2_troop),
             (item_get_slot, ":tier_3_troop", ":center_culture", slot_culture_tier_3_troop),
           (else_try),
             (party_get_slot, ":town_original_culture", "$current_town", slot_center_culture), #获取初始文化
             (item_get_slot, ":troop_prison_guard", ":town_original_culture", slot_culture_prison_guard_troop),
             (item_get_slot, ":troop_castle_guard", ":town_original_culture", slot_culture_castle_guard_troop),
             (item_get_slot, ":tier_2_troop", ":town_original_culture", slot_culture_tier_2_troop),
             (item_get_slot, ":tier_3_troop", ":town_original_culture", slot_culture_tier_3_troop),
           (try_end),
           ...
           (else_try),
             (assign,reg0,"trp_yishith_human_infantry"),
             (assign,reg1,"trp_yishith_human_infantry"),
             (assign,reg2,"trp_yishith_elf_woodguard"),
             (assign,reg3,"trp_yishith_human_militia"),
           (try_end),
           (shuffle_range,0,4),
       ...
       [
           ...
           (else_try),
			 ...
			 (try_begin),
				...
				(try_end),				
			 (try_end),#two message use for cheat mode.
...
#					(assign, "$g_last_assassination_attempt_perpetrator", ":lord"),
             ...
             (party_get_slot, ":mercenary_troop", "$current_town", slot_center_mercenary_troop_type),#mercenary
...
#             (try_for_range, ":companion_candidate", companions_begin, companions_end),#npc酒馆刷新
...
#             (try_end),
             ...
             (try_for_range, ":companion_auxiliary", companions_begin, companions_end),#npc auxiliary
               (troop_get_slot, ":auxiliary_party", ":companion_auxiliary", slot_troop_leading_auxiliary),
               (neq, ":auxiliary_party", 0),
               (troop_slot_eq, ":companion_auxiliary", slot_troop_cur_center, "$current_town"),
			   (neg|troop_slot_ge, ":companion_auxiliary", slot_troop_prisoner_of_party, centers_begin),
			   
               (set_visitor, ":cur_entry", ":companion_auxiliary"),
...
#           (scene_slot_eq,  ":scene", slot_scene_visited, 1), #check if scene has been visited before to allow entry from menu. Otherwise scene will only be accessible from the town center.
       ...
       [
           ...
           (else_try),
             ...
             (set_visitor, 44, "trp_starkhook_enhanced_mercenary"),
             (set_jump_entry, 50),
      ...
      ("town_dungeon",
       ...
       [	   
           (try_begin),
		    (eq, "$talk_context", tc_prison_break), #待改
			...
			(try_begin),
			  (eq, "$g_encountered_party_faction", "fac_player_supporters_faction"),
			  (party_get_slot, ":party_culture", "$current_town", slot_center_culture), #获取初始文化
			(else_try),
                          (faction_get_slot, ":party_culture", "$g_encountered_party_faction", slot_faction_culture), #获取文化
			(try_end),
			(item_slot_eq, ":party_culture", slot_culture_prison_guard_troop, ":agent_type"),
       ...
       [
         ...
         (else_try),                   
           ...
           (else_try),
             (party_get_slot, ":party_culture", "$current_town",  slot_center_culture), #获取初始文化
           (try_end),
           (item_get_slot, ":troop_prison_guard", ":party_culture", slot_culture_prison_guard_troop),
           (set_visitor, 24, ":troop_prison_guard"),
  ...
  (
    ...
    [
      ...
      (else_try),        
        ...
        (else_try),
          (eq, ":bandit_type", "trp_abyssal_sailor"),
    ...
    [
	  ...
	  [
	    ...
	    (else_try),
	      (eq, ":template", "pt_looter_lair"),
	      (assign, ":bandit_troop", "trp_the_forsaken"),
	      
	      (store_faction_of_party, ":starting_town_faction", "$g_starting_town"),
	      
	      (try_begin),
	        (eq, ":starting_town_faction", "fac_kingdom_1"), #player selected Powell city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	    
	      (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_2"), #player selected Yishith city as starting town.
	        (assign, ":scene_to_use", "scn_lair_taiga_bandits"),	    
	      (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_3"), #player selected Kouroto city as starting town.
	        (assign, ":scene_to_use", "scn_lair_steppe_bandits"),	    
	      (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_4"), #player selected Conferderation city as starting town.
	        (assign, ":scene_to_use", "scn_lair_sea_raiders"),
	      (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_5"), #player selected Papal city as starting town.
	        (assign, ":scene_to_use", "scn_lair_mountain_bandits"),
	      (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_6"), #player selected Longshu city as starting town.
	        (assign, ":scene_to_use", "scn_lair_steppe_bandits"),	    
	      (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_7"), #player selected Starkhook city as starting town.
	        (assign, ":scene_to_use", "scn_lair_sea_raiders"),	 
	      (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_8"), #player selected State city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 
	      (try_end),  
	    (try_end),
	    ...
	    (try_for_range, ":unused", 0, ":number_of_bandits_will_be_spawned_at_each_period"),
	      ...
	      (set_visitor, ":random_entry_point", ":bandit_troop", 2),	      
	    (try_end),
    ...
    [
      ...
      [         
        ...
        (try_begin),
          ...
          (assign, ":town_merchant", "trp_confederation_merchant"),
          (assign, ":town_room_scene", "scn_town_1_room"),
        (else_try),  
          (eq, "$current_town", "p_town_15"),
          (assign, ":town_merchant", "trp_papal_merchant"),
          (assign, ":town_room_scene", "scn_town_15_room"),
        (else_try),  
          (eq, "$current_town", "p_town_4"),
          (assign, ":town_merchant", "trp_powell_merchant"),
          (assign, ":town_room_scene", "scn_town_4_room"),
        (else_try),  
          (eq, "$current_town", "p_town_13"),
          (assign, ":town_merchant", "trp_yishith_merchant"),
          (assign, ":town_room_scene", "scn_town_13_room"),
        (else_try),  
          (eq, "$current_town", "p_town_10"),
          (assign, ":town_merchant", "trp_kouruto_merchant"),
          (assign, ":town_room_scene", "scn_town_10_room"),
        (else_try),  
          (eq, "$current_town", "p_town_27"),
          (assign, ":town_merchant", "trp_longshu_merchant"),
          (assign, ":town_room_scene", "scn_town_27_room"),
        (else_try),  
          (eq, "$current_town", "p_town_32"),
          (assign, ":town_merchant", "trp_starkhook_merchant"),
          (assign, ":town_room_scene", "scn_town_32_room"),
        (else_try),  
          (eq, "$current_town", "p_town_34"),
          (assign, ":town_merchant", "trp_state_merchant"),
          (assign, ":town_room_scene", "scn_town_34_room"),
        (try_end),        
  ...
  (
    ...
    [
      ("undead_test",[
         ...
         (quest_get_slot, ":giver_troop", "qst_undead_test", slot_quest_giver_troop),
         (str_store_troop_name, s2, ":giver_troop")
      ],"Continue.",[
         (modify_visitors_at_site, "scn_east_castle"),
         (reset_visitors),
         (assign, reg1, 1),
         (assign, reg2, 2),
         (assign, reg3, 3),
         ...
         (quest_get_slot, ":object_troop", "qst_undead_test", slot_quest_object_troop),
         (set_visitors, 5, ":object_troop", 1),
         (quest_get_slot, ":giver_troop", "qst_undead_test", slot_quest_giver_troop),
         (set_visitor, 6, ":giver_troop"),

         (set_jump_mission,"mt_undead_test"),
         (jump_to_scene,"scn_east_castle"),
         (change_screen_mission),
      ]),
      ...
      ("infiltrate_test",[],
      "infiltrate_test.",[
      (modify_visitors_at_site, "scn_test_scene"),
      (reset_visitors),
      (set_visitor, 0, "trp_player"),
      (set_visitor, 2, "trp_godward_great_swordman"),
      (set_visitor, 7, "trp_heretic_killer"),

      (set_jump_mission,"mt_infiltrate_test"),
      ...
      (reset_visitors),
      (set_visitor, 0, "trp_player"),
      (set_visitor, 1, "trp_godward_great_swordman"),

      (set_jump_mission,"mt_weapon_test"),
      (jump_to_scene,"scn_test_scene"),
      (change_screen_mission),   ]),
      ...
      ("film_test",[],
      "film_test.",[
      (modify_visitors_at_site, "scn_town_34_center"),
      (reset_visitors),
      (set_visitor, 0, "trp_player"),
      (call_script, "script_set_player_substitute"),
      (set_visitor, 41, "trp_fallen_warrior"),
      (set_visitor, 42, "trp_temp_substitute"),
      (set_visitor, 44, "trp_gold_adventurer"),

      (set_jump_mission,"mt_film_test"),
      ...
      ("walker_test",[],
      "walker_test.",[
      (modify_visitors_at_site, "scn_fiend_nest_3"),
      (reset_visitors),
      (set_visitor, 0, "trp_player"),
#      (set_visitor, 2, "trp_patron_knight"),
      (set_visitor, 2, "trp_godward_great_swordman"),

      (set_jump_mission,"mt_walker_test"),
      (jump_to_scene,"scn_fiend_nest_3"),
      (change_screen_mission),   ]),
  ...
  (
    "character_window_auto_change",mnf_auto_enter,
...
#快速战斗-娱乐割草用跳转菜单
  (
    "custom_battle_entertainment",menu_text_color(0xFFFFFF),
    "娱 乐 割 草 模 式 旨 在 使 玩 家 能 使 用 全 部 能 使 用 的 技 能 、 指 挥 所 有 能 指 挥 的 兵 种 、 对 抗 全 部 可 能 在 团 战 中 出 现 的 敌 人 ， 同 时 提 供 给 制 作 者 一 个 测 试 技 能 与 兵 种 斗 蛐 蛐 的 平 台 。 ^“ 友 方 设 置 ” 和 “ 敌 方 设 置 ” 中 分 别 可 以 设 置 己 方 和 敌 方 的 兵 种 ， 各 选 最 多 八 个 。 ^“ 装 备 选 择 ” 中 能 自 行 配 置 装 备 ， 由 于 使 用 了 新 式 物 品 栏 ， 能 装 填 右 手 三 把 ＋ 左 手 三 把 ＋ 两 个 弹 药 一 共 八 件 武 器 。 ^“ 技 能 设 置 ” 中 能 选 择 所 有 已 有 的 主 动 技 能 和 被 动 技 能 ， 主 动 技 能 最 多 选 择 6个 ， 进 场 后 按 123456键 激 发 ， 被 动 技 能 最 多 选 择 36种 。 ^选 择 完 毕 后 ， 点 击 “ 进 入 战 斗 ” 即 可 开 始 战 斗 ， 而 点 击 “ 旁 观 战 斗 ” 则 会 以 一 个 中 立 的 观 察 者 的 身 份 进 入 战 场 。 ",
    "none",
    [(set_background_mesh, "mesh_entertain_mode"),
#(troop_set_slot, "trp_player", slot_troop_active_skill_1, "itm_active_blood_strike"),
#(troop_set_slot, "trp_player", slot_troop_active_skill_2, "itm_active_warcy_bloodsteel"),
#(troop_set_slot, "trp_player", slot_troop_active_skill_3, "itm_active_warcy_bloodburst"),
#(troop_set_slot, "trp_player", slot_troop_active_skill_4, "itm_active_sweep_away"),
#(troop_set_slot, "trp_player", slot_troop_active_skill_5, "itm_active_heavy_casual_attack"),
#(troop_set_slot, "trp_player", slot_troop_active_skill_6, "itm_active_warcy_red_tide"),

#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_stoical"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_ricochet"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_fake_shield"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_damage_management"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_desperate_counterattack"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_desperate_defense"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_starkhook_military_tradition"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_blood_churn"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_blood_motivation"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_blood_boil"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_blood_defend"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_blood_arrogance"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_blood_jealousy"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_bloodswallower"),
#      (call_script, "script_set_player_passive_skill_on_simple", "itm_passive_strong_vitality"),
      ],
    [
      ("enter_bettle",[],
      "进 入 战 斗 。 ",[
         (modify_visitors_at_site, "scn_quick_battle_ground"),
         (reset_visitors),

         (set_visitor, 0, "trp_player"),
         (try_begin),
            (party_get_num_companion_stacks, ":stack_num", "p_temp_party_2"),#已选友方
            (ge, ":stack_num", 1),
            (try_for_range, ":count_no", 0, ":stack_num"),
               (party_stack_get_troop_id, ":troop_no", "p_temp_party_2", ":count_no"),
               (party_stack_get_size, ":count_no_2", "p_temp_party_2", ":count_no"),
               (store_add, ":visitor_no", ":count_no", 1),
               (set_visitors, ":visitor_no", ":troop_no", ":count_no_2"),
            (try_end),
         (try_end),
         (try_begin),
            (party_get_num_companion_stacks, ":stack_num", "p_temp_party"),#已选敌方
            (ge, ":stack_num", 1),
            (try_for_range, ":count_no", 0, ":stack_num"),
               (party_stack_get_troop_id, ":troop_no", "p_temp_party", ":count_no"),
               (party_stack_get_size, ":count_no_2", "p_temp_party", ":count_no"),
               (store_add, ":visitor_no", ":count_no", 9),
               (set_visitors, ":visitor_no", ":troop_no", ":count_no_2"),
            (try_end),
         (try_end),

         (set_jump_mission,"mt_quick_battle_new"),
         (jump_to_scene, "scn_quick_battle_ground"),
         (change_screen_mission),
...
#        (set_visitors, 18, "trp_kouruto_auxiliary_light_infantry", 1),
         (try_begin),
            (party_get_num_companion_stacks, ":stack_num", "p_temp_party_2"),#已选友方
            (ge, ":stack_num", 1),
            (try_for_range, ":count_no", 0, ":stack_num"),
      ...
      "技 能 选 择 。 ",[
         ...
         (assign, "$active_show", -1),
         (assign, "$passive_show", -1),
         (modify_visitors_at_site, "scn_character_window_dungon"),
         (reset_visitors),
         (set_visitor, 2, "trp_player"),
      ...
      ("enemy_set",[],
      "敌 方 设 置 。 ",[
         (assign, "$party_show", "p_temp_party"),#敌方设置
         (modify_visitors_at_site, "scn_character_window_dungon"),
         (reset_visitors),
         (set_visitor, 2, "trp_farmer"),
         (assign, "$troop_show_3", "trp_farmer"),
...
#快速战斗-挑战强敌用跳转菜单
  (
    "custom_battle_formidable_enemy",menu_text_color(0xFFFFFF),
    "已 选 择 劲 敌 ： {s1} ",
    "none",
    [(set_background_mesh, "mesh_formidable_enemy_mode"),
     (try_begin),
        (gt, "$boss_num", 0),
        (troop_get_slot, ":troop_no", "trp_boss_array", "$boss_num"),
        (str_store_troop_name, s1, ":troop_no"),
     (else_try),
    ...
    [
      ("enter_bettle",[
         (gt, "$boss_num", 0),],
      "进 入 战 斗 。 ",[
         (troop_get_slot, ":scene_no", "trp_boss_scene_array", "$boss_num"),
         (try_begin),
            (le, ":scene_no", 0),
            (assign, ":scene_no", "scn_town_1_arena"),
         (try_end),
         ...
         (set_visitor, 0, "trp_player"),
         (troop_get_slot, ":troop_no", "trp_boss_array", "$boss_num"),
         (store_mod, "$boss_choose_1", ":troop_no", 10000),
         (set_visitor, 9, "$boss_choose_1"),#一号boss
         (val_div, ":troop_no", 10000),
         (try_begin),
            (store_mod, "$boss_choose_2", ":troop_no", 10000),#二号boss
            (gt, "$boss_choose_2", 0),
            (set_visitor, 10, "$boss_choose_2"),
         (try_end),
         (try_begin),
            (store_div, "$boss_choose_3", ":troop_no", 10000),#三号boss
            (gt, "$boss_choose_3", 0),
            (set_visitor, 11, "$boss_choose_3"),
         (try_end),
      ...
      "敌 方 设 置 。 ",[
         ...
         (try_begin),
            (gt, "$boss_num", 0),
            (assign, "$boss_num_3", "$boss_num"),#进场时先刷新一次
         (else_try),
            (assign, "$boss_num_3", 1),#进场时先刷新一次
         (try_end),
         (set_jump_mission,"mt_boss_window"),
         (jump_to_scene,"scn_character_window_dungon"),
         (change_screen_mission),]),
...
#快速战斗-会战专用跳转菜单
  (
    "custom_battle_campaign",menu_text_color(0xFFFFFF),
    " ",
    "none",
    [
      (try_begin),
         (neq, "$g_leave_encounter", 1),
         (assign, "$g_quick_battle_encounter_mode_player", 0), #部队进场方式预设
         (assign, "$g_quick_battle_encounter_mode_enemy", 0),
         (assign, "$g_quick_battle_encounter_mode_player_confirmed", 0), #部队进场方式确定
         (assign, "$g_quick_battle_encounter_mode_enemy_confirmed", 0),
         (assign, "$g_quick_battle_encounter_player_num", 1), #双方人数预设
         (assign, "$g_quick_battle_encounter_enemy_num", 1),
         (assign, "$g_quick_battle_party_used", 1), #统计部队用到哪一位了
         (assign, "$g_quick_battle_party_total", 0), #完成设置后记录部队总数
         (assign, "$g_quick_battle_encounter_player_set", -1), #记录正在设置哪一个部队
         (assign, "$g_quick_battle_encounter_enemy_set", -1),
         (assign, "$g_quick_battle_encounter_player_basic_template", 0), #记录基础模板
         (assign, "$g_quick_battle_encounter_enemy_basic_template", 0),
         (assign, "$g_quick_battle_encounter_player_special_template", 0), #记录特殊模板
         (assign, "$g_quick_battle_encounter_enemy_special_template", 0),
         (assign, "$g_quick_battle_encounter_player_party_num", 0), #记录预估部队规模
         (assign, "$g_quick_battle_encounter_enemy_party_num", 0),
         (assign, "$g_quick_battle_encounter_player_formation", 0), #记录阵型，设置为end就是使用大地图相同的逻辑生成
         (assign, "$g_quick_battle_encounter_enemy_formation", 0),
         (try_for_range, ":count_no", total_npcs_begin, total_npcs_end),
            (troop_set_slot, ":count_no", 1, 0), #清空，用于记录npc是否将被加入部队领兵，0未被使用-1已被使用1被玩家选中，2被敌方选中
         (try_end),
         ...
         (try_for_range, ":slot_no", 0, 500),
            (troop_set_slot, "trp_temp_array_detachment", ":slot_no", -1), #清空，用于记录编队
         (try_end),

         (assign, "$g_quick_battle_encounter_mode", 0), #战场模式，0野战1攻城2守城3海战
         (assign, "$g_quick_battle_encounter_mode_confirmed", 0), #战场模式确认选择
         (assign, "$g_quick_battle_encounter_type", 0), #战场类型
         (assign, "$g_quick_battle_encounter_type_confirmed", 0), #战场类型确认选择
         (assign, "$g_quick_battle_encounter_map", 0), #战场类型
         (assign, "$g_quick_battle_encounter_map_set_1", 0), #战场设定1时间
         (assign, "$g_quick_battle_encounter_map_set_2", 0), #战场设定2（比如野战的植被）
         (start_presentation, "prsnt_custom_battle_campaign"),
      (else_try),
         (change_screen_quit),
      (try_end),
    ],
