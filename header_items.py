...
#AoM new
itp_type_separator            = 0x0000000000000015
...
#状态类型
itp_timing_type               = 0x0000000000001000        #计时类
itp_count_type          = 0x0000000000002000         #计次类
itp_unconditional_type             = 0x0000000000004000          #无条件类
itp_enchant       = 0x0000000000020000              #附魔类（计时类特殊分支）

#AoM主动技能
itp_martial_art               = 0x0000000000001000      #武技（消耗精力，有后摇）
itp_sorcery          = 0x0000000000002000               #术法（需要咏唱，无消耗）
itp_magic             = 0x0000000000004000               #魔法（消耗魔力，无咏唱）
itp_riding_skill        = 0x0000000000020000               #骑技（武技的特殊类型，主要给坐骑用，如果有骑乘者，骑乘者也会做相应的动作）
itp_grab_skill        = 0x0000000000040000               #投技（主动技能的特殊类型，抓住目标后双方一起动作）
itp_damage_type              = 0x0000000040000000   #伤害类型的武技，通过通用的触发方式设置启动
itp_special_type              = 0x0000000100000000     #有特殊效果的武技，比如启动某个状态。和造成伤害不冲突。


#AoM阵营树
itp_country_power               = 0x0000000000001000      #已建国的势力
...
itp_couchable                = 0x0000000080000000            #骑枪冲锋
...
itp_supply     = 0x0000000004000000  #急救包
itp_accessorise      = 0x0000000008000000   #首饰
itp_small_tool    = 0x0000000010000000   #小道具
itp_expendable                 = 0x0000000020000000   #消耗品（在物品栏里直接使用）
...
itp_left_hand_weapon              = 0x0000200000000000#盾牌用
...
#new flag
itp_bonus_against_horse           = 0x0800000000000000
...
itc_dagger  = itc_cleaver | itcf_thrust_onehanded | itcf_horseback_thrust_onehanded
...
itc_greatlance = itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback| itcf_thrust_polearm |itcf_overswing_spear|itcf_overswing_musket

#####cannot used on horse back
itc_poleaxe    = itc_parry_polearm| itcf_overswing_polearm |itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm

#####cannot swing on horse back
itc_staff      = itc_parry_polearm| itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback| itcf_overswing_polearm |itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm |itcf_overswing_spear|itcf_overswing_musket
itc_cutting_spear = itc_spear|itcf_overswing_polearm |itcf_overswing_spear|itcf_overswing_musket
...
#####AoM poleam
#不能配盾的长杆
itc_shieldless_slashable_spear = itc_parry_polearm|itcf_overswing_polearm|itcf_thrust_polearm|itcf_overswing_spear|itcf_overswing_musket|itcf_slashright_polearm|itcf_slashleft_polearm|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded|itcf_thrust_onehanded_lance|itcf_thrust_onehanded_lance_horseback

#配盾只能直刺的可挥舞长杆
itc_shieldlimit_slashable_spear = itc_parry_polearm|itcf_overswing_polearm|itcf_thrust_polearm|itcf_overswing_spear|itcf_overswing_musket|itcf_slashright_polearm|itcf_slashleft_polearm|itcf_thrust_onehanded_lance|itcf_thrust_onehanded_lance_horseback

#马上可挥舞长杆
itc_mounted_slashable_spear = itc_parry_polearm|itcf_overswing_polearm|itcf_thrust_polearm|itcf_overswing_spear|itcf_overswing_musket|itcf_slashright_polearm|itcf_slashleft_polearm|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded|itcf_thrust_onehanded_lance_horseback|itcf_thrust_onehanded_lance

#完全可挥舞长杆
itc_currency_slashable_spear = itc_parry_polearm|itcf_overswing_polearm|itcf_thrust_polearm|itcf_overswing_spear|itcf_overswing_musket|itcf_slashright_polearm|itcf_slashleft_polearm|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded|itcf_thrust_onehanded_lance_horseback|itcf_overswing_onehanded|itcf_slashright_onehanded|itcf_slashleft_onehanded|itcf_thrust_onehanded_lance

#限定步战可挥舞长杆
itc_mountless_halberd = itc_parry_polearm|itcf_overswing_polearm|itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm|itcf_thrust_onehanded_lance

#可防御的长杆
itc_parryable_greatlance = itc_parry_polearm|itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback | itcf_thrust_polearm



itc_musket_melee = itc_parry_polearm|itcf_overswing_musket|itcf_overswing_spear|itcf_overswing_musket|itcf_slashright_twohanded|itcf_slashleft_twohanded
