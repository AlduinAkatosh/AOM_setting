...
knows_devout_1            = 0x01 << (skl_devout << 2)
knows_devout_2            = 0x02 << (skl_devout << 2)
knows_devout_3            = 0x03 << (skl_devout << 2)
knows_devout_4            = 0x04 << (skl_devout << 2)
knows_devout_5            = 0x05 << (skl_devout << 2)
knows_devout_6            = 0x06 << (skl_devout << 2)
knows_devout_7            = 0x07 << (skl_devout << 2)
knows_devout_8            = 0x08 << (skl_devout << 2)
knows_devout_9            = 0x09 << (skl_devout << 2)
knows_devout_10           = 0x0A << (skl_devout << 2)
knows_devout_11           = 0x0B << (skl_devout << 2)
knows_devout_12           = 0x0C << (skl_devout << 2)
knows_devout_13           = 0x0D << (skl_devout << 2)
knows_devout_14           = 0x0E << (skl_devout << 2)
knows_devout_15           = 0x0F << (skl_devout << 2)
knows_study_1            = 0x01 << (skl_study << 2)
knows_study_2            = 0x02 << (skl_study << 2)
knows_study_3            = 0x03 << (skl_study << 2)
knows_study_4            = 0x04 << (skl_study << 2)
knows_study_5            = 0x05 << (skl_study << 2)
knows_study_6            = 0x06 << (skl_study << 2)
knows_study_7            = 0x07 << (skl_study << 2)
knows_study_8            = 0x08 << (skl_study << 2)
knows_study_9            = 0x09 << (skl_study << 2)
knows_study_10           = 0x0A << (skl_study << 2)
knows_study_11           = 0x0B << (skl_study << 2)
knows_study_12           = 0x0C << (skl_study << 2)
knows_study_13           = 0x0D << (skl_study << 2)
knows_study_14           = 0x0E << (skl_study << 2)
knows_study_15           = 0x0F << (skl_study << 2)
knows_memory_1            = 0x01 << (skl_memory << 2)
knows_memory_2            = 0x02 << (skl_memory << 2)
knows_memory_3            = 0x03 << (skl_memory << 2)
knows_memory_4            = 0x04 << (skl_memory << 2)
knows_memory_5            = 0x05 << (skl_memory << 2)
knows_memory_6            = 0x06 << (skl_memory << 2)
knows_memory_7            = 0x07 << (skl_memory << 2)
knows_memory_8            = 0x08 << (skl_memory << 2)
knows_memory_9            = 0x09 << (skl_memory << 2)
knows_memory_10           = 0x0A << (skl_memory << 2)
knows_memory_11           = 0x0B << (skl_memory << 2)
knows_memory_12           = 0x0C << (skl_memory << 2)
knows_memory_13           = 0x0D << (skl_memory << 2)
knows_memory_14           = 0x0E << (skl_memory << 2)
knows_memory_15           = 0x0F << (skl_memory << 2)
knows_array_arrangement_1            = 0x01 << (skl_array_arrangement << 2)
knows_array_arrangement_2            = 0x02 << (skl_array_arrangement << 2)
knows_array_arrangement_3            = 0x03 << (skl_array_arrangement << 2)
knows_array_arrangement_4            = 0x04 << (skl_array_arrangement << 2)
knows_array_arrangement_5            = 0x05 << (skl_array_arrangement << 2)
knows_array_arrangement_6            = 0x06 << (skl_array_arrangement << 2)
knows_array_arrangement_7            = 0x07 << (skl_array_arrangement << 2)
knows_array_arrangement_8            = 0x08 << (skl_array_arrangement << 2)
knows_array_arrangement_9            = 0x09 << (skl_array_arrangement << 2)
knows_array_arrangement_10           = 0x0A << (skl_array_arrangement << 2)
knows_array_arrangement_11           = 0x0B << (skl_array_arrangement << 2)
knows_array_arrangement_12           = 0x0C << (skl_array_arrangement << 2)
knows_array_arrangement_13           = 0x0D << (skl_array_arrangement << 2)
knows_array_arrangement_14           = 0x0E << (skl_array_arrangement << 2)
knows_array_arrangement_15           = 0x0F << (skl_array_arrangement << 2)
