...
("walker_roar_1", sf_2d, ["walker_roar_1.mp3"]),
("walker_roar_2", sf_2d, ["walker_roar_2.mp3"]),
("walker_roar_3", sf_2d, ["walker_roar_3.mp3"]),
("walker_roar_4", sf_2d, ["walker_roar_4.mp3"]),

("hit_ground", sf_2d, ["hit_ground.mp3"]),
("break_ground", sf_2d, ["break_ground.mp3"]),
("storm", sf_2d, ["storm.mp3"]),

("kill_repeat", sf_2d, ["kill_repeat.mp3"]),

 ("inflitration_sound_1",sf_priority_7|sf_vol_10, ["clang_metal_1.ogg"]),
 ("inflitration_sound_2",sf_priority_7|sf_vol_10, ["coins_dropped_2.ogg"]),
]
