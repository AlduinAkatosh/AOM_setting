...
##  ("nothing", "nothing"),
  ...
  ("one_word_text", "{s1}"),
  ("two_word_text", "{s1}{s2}"),
  ("three_word_text", "{s1}{s2}{s3}"),
  ("four_word_text", "{s1}{s2}{s3}{s4}"),
...
#npc22 = Ai_Miye
  ...
  ("npc16_intro", "Hello there1."),
  ("npc17_intro", "Hello there2."),
  ("npc18_intro", "Hello there3."),
  ("npc19_intro", "Hello there4."),
  ("npc20_intro", "Hello there5."),
  ("npc21_intro", "Hello there6."),
  ("npc22_intro", "Hello there7."),
  ...
  ("npc17_intro_response_1", "I could be1."),
  ("npc18_intro_response_1", "I could be2."),
  ("npc19_intro_response_1", "I could be3."),
  ("npc20_intro_response_1", "I could be4."),
  ("npc21_intro_response_1", "I could be5."),
  ("npc22_intro_response_1", "I could be6."),
  ...
  ("npc16_intro_response_2", "Mind your own business, lass1."),
  ("npc17_intro_response_2", "Mind your own business, lass2."),
  ("npc18_intro_response_2", "Mind your own business, lass3."),
  ("npc19_intro_response_2", "Mind your own business, lass4."),
  ("npc20_intro_response_2", "Mind your own business, lass5."),
  ("npc21_intro_response_2", "Mind your own business, lass6."),
  ("npc22_intro_response_2", "Mind your own business, lass7."),
...
#backstory intro
  ...
  ("npc16_backstory_a", "1Well, {sir/madame}, as long as I can remember I've had a weakness for pretty things, and it's gotten me into trouble, you see."),
  ("npc17_backstory_a", "2Well, {sir/madame}, as long as I can remember I've had a weakness for pretty things, and it's gotten me into trouble, you see."),
  ("npc18_backstory_a", "3Well, {sir/madame}, as long as I can remember I've had a weakness for pretty things, and it's gotten me into trouble, you see."),
  ("npc19_backstory_a", "4Well, {sir/madame}, as long as I can remember I've had a weakness for pretty things, and it's gotten me into trouble, you see."),
  ("npc20_backstory_a", "5Well, {sir/madame}, as long as I can remember I've had a weakness for pretty things, and it's gotten me into trouble, you see."),
  ("npc21_backstory_a", "6Well, {sir/madame}, as long as I can remember I've had a weakness for pretty things, and it's gotten me into trouble, you see."),
  ("npc22_backstory_a", "7Well, {sir/madame}, as long as I can remember I've had a weakness for pretty things, and it's gotten me into trouble, you see."),
...
#backstory main body
  ...
  ("npc17_backstory_b", "I grew up in Malayurg castle as a bonded servant, working alongside my mother in the kitchens. I would amuse myself by hunting mice through the pantries and sculleries. I was so good at it that I put the castle cats out of a job, and eventually the lord realized that I might also be employed to track down bigger game, on certain errands of a type perhaps better left unsaid. Needless to say, I found a number of opportunities to avail myself of trinkets that had formerly belonged to my lord's enemies. So I was able to buy myself out of bondage, and find hire as a free agent. My last job was {s19}in {s20}."),
...
#backstory recruit pitch
  ...
  ("npc17_backstory_c", "Unfortunately, my last employer's wife had a lovely amulet, of a kind I simply could not resist. She doesn't know it's missing, yet, but she might soon. So tell me, are you looking for helpers?"),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc17_signup", "Well, {sir/madame}, let me tell you. I may not know how to read and write, but I know the quickest way to a man's heart is between his fourth and fifth rib, if you understand me. "),
  ...
  ("npc17_signup_2", "I can throw knives, in addition to stabbing with them, and I'm slippery as quicksilver. You'll find me useful in a fight, I'll warrant."),
...
#11
  ...
  ("npc2_payment", "I will be very useful to you, {sir/madame}, you can bet on that. Just one more thing before we leave, would you mind lending me {reg3} denars? I am ashamed to say it, but I have made myself a bit of debt here, staying in this tavern over the last few weeks and the tavern owners no longer believe that I am loaded with gold as I used to tell them. You know, things could get ugly here if they see me leaving with you before paying them."),
  ("npc3_payment", "{!}."),
  ("npc4_payment", "{!}."),
  ...
  ("npc6_payment", "I will be very useful to you, {sir/madame}, you can bet on that. Just one more thing before we leave, would you mind lending me {reg3} denars? I am ashamed to say it, but I have made myself a bit of debt here, staying in this tavern over the last few weeks and the tavern owners no longer believe that I am loaded with gold as I used to tell them. You know, things could get ugly here if they see me leaving with you before paying them."),
  ...
  ("npc12_payment", "Hey thank you captain. But before joining up with you, I would ask for a payment of {reg3} denars. I know that in war parties soldiers can go on for weeks without seeing any wages. I am wise enough not to sign anywhere without having myself covered."),
  ...
  ("npc17_payment", "Now, that's good news, captain. So, how about paying me a little something to seal off our agreement? A mere {reg3} would be enough. Please don't take this the wrong way, but I've had some bad luck with employers in the past. "),
  ...
  ("npc6_payment_response", "Well... here's {reg3} denars, then. Your first payment."),
  ...
  ("npc12_payment_response", "Very well, here's {reg3} denars. Make yourself ready. We leave soon."),
  ...
  ("npc18_2ary_morality_speech", "Captain -- just so you know, it's no problem by me that we {s21}. We do what we need to do to live, and they'd do the same to us if they were in our shoes."),
  ...
  ("npc20_2ary_morality_speech", "Captain -- just so you know, it's no problem by me that we {s21}. We do what we need to do to live, and they'd do the same to us if they were in our shoes."),
  ("npc21_2ary_morality_speech", "Captain -- just so you know, it's no problem by me that we {s21}. We do what we need to do to live, and they'd do the same to us if they were in our shoes."),
  ("npc22_2ary_morality_speech", "Captain -- just so you know, it's no problem by me that we {s21}. We do what we need to do to live, and they'd do the same to us if they were in our shoes."),
  ...
  ("npc20_personalityclash_speech", "Oy, captain. Just so you know -- there's something funny about {s11}. He makes strange scrawlings in the dirt, and mutters to himself."),
  ("npc21_personalityclash_speech", "Oy, captain. Just so you know -- there's something funny about {s11}. He makes strange scrawlings in the dirt, and mutters to himself."),
  ("npc22_personalityclash_speech", "Oy, captain. Just so you know -- there's something funny about {s11}. He makes strange scrawlings in the dirt, and mutters to himself."),
  ...
  ("npc20_personalityclash_speech_b", "Fearing witchcraft, I asked him about it, and he told me that a chit of a girl like myself should mind her own business. So I had a look in his baggage, and found strange plans and diagrams. I think he's a sorceror, {sir/madame}, and if I catch him trying to hex me he'll have a knife in his throat."),
  ("npc21_personalityclash_speech_b", "Fearing witchcraft, I asked him about it, and he told me that a chit of a girl like myself should mind her own business. So I had a look in his baggage, and found strange plans and diagrams. I think he's a sorceror, {sir/madame}, and if I catch him trying to hex me he'll have a knife in his throat."),
  ("npc22_personalityclash_speech_b", "Fearing witchcraft, I asked him about it, and he told me that a chit of a girl like myself should mind her own business. So I had a look in his baggage, and found strange plans and diagrams. I think he's a sorceror, {sir/madame}, and if I catch him trying to hex me he'll have a knife in his throat."),
...
### set off by behavior after victorious battle
  ...
  ("npc20_personalityclash2_speech", "Beg your pardon, {sir/ma'am}. {s11} might have been a very good thief, but he's not got the stomach to be a warrior, if you ask me."),
  ("npc21_personalityclash2_speech", "Beg your pardon, {sir/ma'am}. {s11} might have been a very good thief, but he's not got the stomach to be a warrior, if you ask me."),
  ("npc22_personalityclash2_speech", "Beg your pardon, {sir/ma'am}. {s11} might have been a very good thief, but he's not got the stomach to be a warrior, if you ask me."),
  ...
  ("npc20_personalityclash2_speech_b", "After our last scrap, I was slicing open the guts of some our foes to check for hidden gold, as a girl who counts her pennies ought. He gagged and muttered that I was an 'animal.' I'll inspect his innards for contraband if he doesn't keep a civil tongue in his head."), #klethi - borcha
  ("npc21_personalityclash2_speech_b", "After our last scrap, I was slicing open the guts of some our foes to check for hidden gold, as a girl who counts her pennies ought. He gagged and muttered that I was an 'animal.' I'll inspect his innards for contraband if he doesn't keep a civil tongue in his head."), #klethi - borcha
...
#local color strings
  ...
  ("npc17_honorific", "captain"), #klethi
  ("npc18_honorific", "captain"), #klethi
  ("npc19_honorific", "captain"), #klethi
  ("npc20_honorific", "captain"), #klethi
  ("npc21_honorific", "captain"), #klethi
  ("npc22_honorific", "captain"), #klethi
  ...
  ("npc17_kingsupport_1", "Why not, captain? I'm sure you'd make a fine {king/queen} -- and of course I'd hope you remember the little people like myself who did you a pretty turn on your scramble to the throne."), #klethi
  ...
  ("npc20_kingsupport_1", "Why not, captain? I'm sure you'd make a fine {king/queen} -- and of course I'd hope you remember the little people like myself who did you a pretty turn on your scramble to the throne."), #klethi
  ("npc21_kingsupport_1", "Why not, captain? I'm sure you'd make a fine {king/queen} -- and of course I'd hope you remember the little people like myself who did you a pretty turn on your scramble to the throne."), #klethi
  ("npc22_kingsupport_1", "Why not, captain? I'm sure you'd make a fine {king/queen} -- and of course I'd hope you remember the little people like myself who did you a pretty turn on your scramble to the throne."), #klethi
  ...
  ("npc17_kingsupport_2", "Of course, my {lord/lady}. And what's more, I figure a girl like me could do you a bit of a service raising support with the lords of this land. I may have only had a small part in their schemes and intrigues over the years, but I think I know what they want. And given what I know of their secrets, they'd not want to be denying me admission to their halls, now would they?"), #klethi
  ...
  ("npc17_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take"), #klethi
  ...
  ("npc20_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take"), #klethi
  ("npc21_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take"), #klethi
  ("npc22_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take"), #klethi
...
#
  ...
  ("npc17_woman_to_woman", "Oy, Captain -- if you don't mind me saying, you've made quite a name for yourself in these parts. I suspect that if you were a man, a king would have offered you a fief by now. But we ladies should come to expect things like that. Men will find any excuse not to reward us for our work, so if we take a fancy to a bit of land somewhere, maybe we should just reach out and take it. That's the way I look at the world, anyway."), #klethi
  ("npc18_woman_to_woman", "Oy, Captain -- if you don't mind me saying, you've made quite a name for yourself in these parts. I suspect that if you were a man, a king would have offered you a fief by now. But we ladies should come to expect things like that. Men will find any excuse not to reward us for our work, so if we take a fancy to a bit of land somewhere, maybe we should just reach out and take it. That's the way I look at the world, anyway."), #klethi
  ("npc19_woman_to_woman", "Oy, Captain -- if you don't mind me saying, you've made quite a name for yourself in these parts. I suspect that if you were a man, a king would have offered you a fief by now. But we ladies should come to expect things like that. Men will find any excuse not to reward us for our work, so if we take a fancy to a bit of land somewhere, maybe we should just reach out and take it. That's the way I look at the world, anyway."), #klethi
  ("npc20_woman_to_woman", "Oy, Captain -- if you don't mind me saying, you've made quite a name for yourself in these parts. I suspect that if you were a man, a king would have offered you a fief by now. But we ladies should come to expect things like that. Men will find any excuse not to reward us for our work, so if we take a fancy to a bit of land somewhere, maybe we should just reach out and take it. That's the way I look at the world, anyway."), #klethi
  ("npc21_woman_to_woman", "Oy, Captain -- if you don't mind me saying, you've made quite a name for yourself in these parts. I suspect that if you were a man, a king would have offered you a fief by now. But we ladies should come to expect things like that. Men will find any excuse not to reward us for our work, so if we take a fancy to a bit of land somewhere, maybe we should just reach out and take it. That's the way I look at the world, anyway."), #klethi
  ("npc22_woman_to_woman", "Oy, Captain -- if you don't mind me saying, you've made quite a name for yourself in these parts. I suspect that if you were a man, a king would have offered you a fief by now. But we ladies should come to expect things like that. Men will find any excuse not to reward us for our work, so if we take a fancy to a bit of land somewhere, maybe we should just reach out and take it. That's the way I look at the world, anyway."), #klethi
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("in_auxiliary", "In auxiliary {s5}{s4}{s8}{s7}."),
  ...
  ("name_auxiliary_text", "What will be the name of this auxiliary?"),
  ("default_auxiliary_name", "{s0}'s Kingdom"),
 ...
 ("journey_to_praven", "You came by caravan through the heartland of Calradia. Green shoots of wheat, barley and oats are beginning to push through the dark soil of the rolling hills, and on the lower slopes of the snowcapped mountains, herds of cattle and sheep are grazing on the spring grass. Occasionally, too, you catch sight of one of the great warhorses that are the pride of the Swadian nobility. The land here is rich -- but also troubled, as the occasional burnt-out farm bears witness. You keep a wide berth of the forests, where desperate men have taken refuge, and it is some relief when you crest a ridge and catch sight of the great port of Praven, its rooftops made golden by the last rays of the setting sun."),
  ...
  ("journey_to_starkhook", "You came with a caravan, crossing the great desert to the east of Calradia. The bedouin guides chose your route carefully, leapfrogging through treacherous dune fields and across empty gravel plains to low-lying oases rich with orchards and date palms. Your great fear was that the caravan might lose its way and perish of thirst. The small bands of raiders who hovered just out of bowshot, waiting to pick off stragglers, were oddly a comfort -- at least water could be no more than a day's ride away. It was a great relief when the mountains came into view, and on the evening of the following day you crested a rocky pass and in the distance could make out the sea, and the towers of Shariz silhouetted against the sunset."),

  ("journey_to_state", "You came with a caravan, crossing the great desert to the east of Calradia. The bedouin guides chose your route carefully, leapfrogging through treacherous dune fields and across empty gravel plains to low-lying oases rich with orchards and date palms. Your great fear was that the caravan might lose its way and perish of thirst. The small bands of raiders who hovered just out of bowshot, waiting to pick off stragglers, were oddly a comfort -- at least water could be no more than a day's ride away. It was a great relief when the mountains came into view, and on the evening of the following day you crested a rocky pass and in the distance could make out the sea, and the towers of Shariz silhouetted against the sunset."),
...
("the_coast", "the coast"),
  ...
  ("study", "study"),
  ("devout", "devout"),
  ("prisoner_management", "prisoner_management"),
  ...
  ("bonus_against_horse", "bonus_against_horse"),

  ("cant_reload_on_horseback", "cant_reload_on_horseback"),
  ("cant_use_on_horseback", "cant_use_on_horseback"),
  ("unbalanced", "unbalanced"),
  ("cant_reload_while_moving", "cant_reload_while_moving"),

  ("cant_have_more_modifier", "cant_have_more_modifier"),
##here begins the new modifier
  ("imod_plain", "imod_plain"),
  ("imod_cracked", "imod_cracked"),
  ("imod_rusty", "imod_rusty"),
  ("imod_bent", "imod_bent"),
  ("imod_chipped", "imod_chipped"),
  ("imod_battered", "imod_battered"),
  ("imod_poor", "imod_poor"),           #not use
  ("imod_crude", "imod_crude"),
  ("imod_old", "imod_old"),          #not use
  ("imod_cheap", "imod_cheap"),
  ("imod_fine", "imod_fine"),          #not use
  ("imod_well_made", "imod_well_made"),          #not use
  ("imod_sharp", "imod_sharp"),          #not use
  ("imod_balanced", "imod_balanced"),
  ("imod_tempered", "imod_tempered"),
  ("imod_deadly", "imod_deadly"),          #not use
  ("imod_exquisite", "imod_exquisite"),          #not use
  ("imod_masterwork", "imod_masterwork"),
  ("imod_heavy", "imod_heavy"),
  ("imod_strong", "imod_strong"),
  ("imod_powerful", "imod_powerful"),          #not use
  ("imod_tattered", "imod_tattered"),
  ("imod_ragged", "imod_ragged"),
  ("imod_rough", "imod_rough"),          #not use
  ("imod_sturdy", "imod_sturdy"),
  ("imod_thick", "imod_thick"),
  ("imod_hardened", "imod_hardened"),
  ("imod_reinforced", "imod_reinforced"),
  ("imod_superb", "imod_superb"),
  ("imod_lordly", "imod_lordly"),
  ("imod_lame", "imod_lame"),
  ("imod_swaybacked", "imod_swaybacked"),
  ("imod_stubborn", "imod_stubborn"),
  ("imod_timid", "imod_timid"),
  ("imod_meek", "imod_meek"),          #not use
  ("imod_spirited", "imod_spirited"),
  ("imod_champion", "imod_champion"),
  ("imod_fresh", "imod_fresh"),
  ("imod_day_old", "imod_day_old"),
  ("imod_two_day_old", "imod_two_day_old"),
  ("imod_smelling", "imod_smelling"),
  ("imod_rotten", "imod_rotten"),
  ("imod_large_bag", "imod_large_bag"),


  ("auxiliary_escape", "{s5} escape to {s4}"),
  ...
  ("grade_gold", "gold"),
  ("grade_mithril", "mithril"),
  ("grade_orichalcos", "orichalcos"),
  ("grade_primordite", "primordite"),
  ...
  ("sorcery", "sorcery"),
  ("magic", "magic"),
  ("vigour_consume", "vigour_consume"),
  ("chant_time_consume", "chant_time_consume"),
  ("magic_consume", "magic_consume"),

  ("timing_type", "timing_type"),
  ("counting_type", "counting_type"),
  ("unlimited", "unlimited"),
  ("basic_timer_add", "basic_timer_add"),
  ("basic_timer", "basic_timer"),
  ("basic_timer_minus", "basic_timer_minus"),
  ("unlimited", "unlimited"),
  ("basic_times", "basic_times"),

  ("player_sorcery_set", "Player activate {s10} in field {s8}."),
  ("sorcery_upgrade", "{s9} upgrade to {s10} in field {s8}."),
  ("new_sorcery", "New sorcery is unlocked in {s8}."),
  ("change_teacher", "{s9} change his teahcer to {s8}."),

  ("necromancer_upgrade", "necromancer_upgrade"),

  ("beheading_necromancer_introduce", "beheading_necromancer_introduce"),
  ("inflammation_necromancer_introduce", "inflammation_necromancer_introduce"),
  ("cyan_necromancer_introduce", "cyan_necromancer_introduce"),
  ("armor_necromancer_introduce", "armor_necromancer_introduce"),
  ("shower_necromancer_introduce", "shower_necromancer_introduce"),
  ("shattered_necromancer_introduce", "shattered_necromancer_introduce"),
  ("element_necromancer_introduce", "element_necromancer_introduce"),
  ("power_necromancer_introduce", "power_necromancer_introduce"),
  ("shadow_necromancer_introduce", "shadow_necromancer_introduce"),
  ("storm_necromancer_introduce", "storm_necromancer_introduce"),
  ("defend_necromancer_introduce", "defend_necromancer_introduce"),

  ("teacher_1", "teacher_1"),#inflammation
  ("teacher_2", "teacher_2"),
  ("teacher_3", "teacher_3"),
  ("teacher_4", "teacher_4"),
  ("teacher_5", "teacher_5"),
  ...
  ("teacher_8", "teacher_8"),
  ("teacher_9", "teacher_9"),
  ("teacher_10", "teacher_10"),
  ("teacher_11", "teacher_11"),

  ("assistant_1", "assistant_1"),
  ("assistant_2", "assistant_2"),
  ("assistant_3", "assistant_3"),
  ("assistant_4", "assistant_4"),
  ("assistant_5", "assistant_5"),
  ("assistant_6", "assistant_6"),
  ("assistant_7", "assistant_7"),
  ("assistant_8", "assistant_8"),

  ("assistant_introduce_necromance_1", "assistant_introduce_necromance_1"),
  ("assistant_introduce_necromance_2", "assistant_introduce_necromance_2"),
  ("assistant_introduce_necromance_3", "assistant_introduce_necromance_3"),
  ("assistant_introduce_necromance_4", "assistant_introduce_necromance_4"),

  ("teacher_introduce_necromance_1", "teacher_introduce_necromance_1"),
  ("teacher_introduce_necromance_2", "teacher_introduce_necromance_2"),
  ("teacher_introduce_necromance_3", "teacher_introduce_necromance_3"),
  ("teacher_introduce_necromance_4", "teacher_introduce_necromance_4"),

  ("apprentice_1", "apprentice_1"),
  ("apprentice_2", "apprentice_2"),
  ("apprentice_3", "apprentice_3"),
  ("apprentice_4", "apprentice_4"),
  ("apprentice_5", "apprentice_5"),
  ("apprentice_6", "apprentice_6"),
  ("apprentice_7", "apprentice_7"),
  ("apprentice_8", "apprentice_8"),
  ("apprentice_9", "apprentice_9"),
  ("apprentice_10", "apprentice_10"),
  ("apprentice_11 ", "apprentice_11"),
  ("apprentice_12", "apprentice_12"),
  ("apprentice_13", "apprentice_13"),
  ("apprentice_14", "apprentice_14"),
  ("apprentice_15", "apprentice_15"),
  ("apprentice_16", "apprentice_16"),
  ("apprentice_17", "apprentice_17"),

  ("necromance_quest_discription_1", "necromance_quest_discription_1"),
  ("necromance_quest_discription_2", "necromance_quest_discription_2"),
  ("necromance_quest_discription_3", "necromance_quest_discription_3"),
  ("necromance_quest_discription_4", "necromance_quest_discription_4"),
  ("necromance_quest_discription_5", "necromance_quest_discription_5"),
  ("necromance_quest_discription_6", "necromance_quest_discription_6"),
  ("necromance_quest_discription_7", "necromance_quest_discription_7"),
  ("necromance_quest_discription_8", "necromance_quest_discription_8"),
  ("necromance_quest_discription_9", "necromance_quest_discription_9"),
  ("necromance_quest_discription_10", "necromance_quest_discription_10"),
  ("necromance_quest_discription_11", "necromance_quest_discription_11"),
  ("necromance_quest_discription_12", "necromance_quest_discription_12"),
  ("necromance_quest_discription_13", "necromance_quest_discription_13"),

  ("necromance_quest_text_1", "necromance_quest_text_1"),
  ("necromance_quest_text_2", "necromance_quest_text_2"),
  ("necromance_quest_text_3", "necromance_quest_text_3"),
  ("necromance_quest_text_4", "necromance_quest_text_4"),
  ("necromance_quest_text_5", "necromance_quest_text_5"),
  ("necromance_quest_text_6", "necromance_quest_text_6"),
  ("necromance_quest_text_7", "necromance_quest_text_7"),
  ("necromance_quest_text_8", "necromance_quest_text_8"),
  ("necromance_quest_text_9", "necromance_quest_text_9"),
  ("necromance_quest_text_10", "necromance_quest_text_10"),
  ("necromance_quest_text_11", "necromance_quest_text_11"),
  ("necromance_quest_text_12", "necromance_quest_text_12"),
  ("necromance_quest_text_13", "necromance_quest_text_13"),

  ("destroy_results_add_information", "destroy_results_add_information"),

  ("kingdom_1_reinforcements_a", "普 威 尔 联 合 王 国 初 级 征 召 兵 "),
  ("kingdom_1_reinforcements_b", "普 威 尔 联 合 王 国 中 级 征 召 兵 "),
  ("kingdom_1_reinforcements_c", "普 威 尔 联 合 王 国 高 级 征 召 兵 "),
  ("kingcity_citizen_reinforcements_a", "普 威 尔 王 都 初 级 志 愿 兵 "),
  ("kingcity_citizen_reinforcements_b", "普 威 尔 王 都 高 级 志 愿 兵 "),
  ("eliminater_reinforcements", "肃 正 军 团 "),
  ("rodriguez_duchy_reinforcements_a", "罗 德 里 格 斯 公 国 民 兵 "),
  ("rodriguez_duchy_reinforcements_b", "罗 德 里 格 斯 公 国 骑 士 "),
  ("bloodfire_mercenary_reinforcements", "血 火 佣 兵 团 "),
  ("grenier_militia_reinforcements", "戈 兰 尼 尔 民 兵 自 卫 军 "),
  ("northern_reclaimer_reinforcements_a", "北 境 开 拓 领 初 级 部 队 "),
  ("northern_reclaimer_reinforcements_b", "北 境 开 拓 领 中 级 部 队 "),
  ("northern_reclaimer_reinforcements_c", "北 境 开 拓 领 高 级 部 队 "),
  ("brand_dragonmania_reinforcements", "龙 孽 天 灾 "),
  ("powell_state_reinforcements", "普 属 自 由 城 邦 志 愿 兵 "),
  ("powell_orthodox_reinforcements", "普 威 尔 正 教 军 团 "),
  ("sousanth_duchy_reinforcements_a", "南 沙 公 国 民 兵 "),
  ("sousanth_duchy_reinforcements_b", "南 沙 公 国 精 锐 "),
  ("dragon_worship_reinforcements_a", "龙 神 教 信 众 军 "),
  ("dragon_worship_reinforcements_b", "龙 神 教 高 阶 信 徒 军 "),

  ("kingdom_2_reinforcements_a", "伊 希 斯 公 国 人 类 仆 从 兵 "),
  ("kingdom_2_reinforcements_b", "伊 希 斯 公 国 半 精 灵 征 召 兵 "),
  ("kingdom_2_reinforcements_c", "伊 希 斯 公 国 半 精 灵 巡 林 者 "),
  ("spirittree_of_soul_reinforcements_a", "灵 魄 之 灵 树 低 阶 部 队 "),
  ("spirittree_of_soul_reinforcements_b", "灵 魄 之 灵 树 高 阶 部 队 "),
  ("spirittree_of_demise_reinforcements_a", "死 亡 之 灵 树 低 阶 部 队 "),
  ("spirittree_of_demise_reinforcements_b", "死 亡 之 灵 树 低 阶 部 队 "),
  ("molter_legion_reinforcements", "蜕 生 者 战 团 部 队 "),
  ("spirittree_of_ancester_reinforcements", "先 祖 之 灵 树 作 战 部 队 "),
  ("yishith_westcoast_militia_reinforcements", "伊 希 斯 西 海 自 警 团 "),
  ("spirittree_of_vita_reinforcements", "伊 希 斯 公 国 海 军 "),

  ("kingdom_3_reinforcements_a", "科 鲁 托 酋 长 国 低 级 无 族 者 "),
  ("kingdom_3_reinforcements_b", "科 鲁 托 酋 长 国 中 级 无 族 者 "),
  ("kingdom_3_reinforcements_c", "科 鲁 托 酋 长 国 高 级 无 族 者 "),
  ("tiger_tribe_reinforcements", "虎 族 部 落 兵 "),
  ("bear_tribe_reinforcements", "熊 族 部 落 兵 "),
  ("wolf_tribe_reinforcements", "狼 族 部 落 兵 "),
  ("lion_tribe_reinforcements", "狮 族 部 落 兵 "),
  ("totem_allience_reinforcements_a", "图 腾 同 盟 改 革 军 新 兵 队 "),
  ("totem_allience_reinforcements_b", "图 腾 同 盟 改 革 军 步 兵 队 "),
  ("totem_allience_reinforcements_c", "图 腾 同 盟 改 革 军 骑 兵 队 "),
  ("furnace_watch_brigade_reinforcements", "洪 炉 监 视 者 战 团 "),
  ("kouruto_auxiliary_reinforcements", "科 鲁 托 辅 军 佣 兵 团 "),
  ("cow_tribe_reinforcements", "牛 族 部 落 兵 "),
  ("sheep_tribe_reinforcements", "羊 族 部 落 兵 "),
  ("deer_tribe_reinforcements", "鹿 族 部 落 兵 "),
  ("rabbit_tribe_reinforcements", "兔 族 部 落 兵 "),
  ("goldclaw_reinforcements", "金 爪 子 帮 合 训 部 队 "),
  ("sentinel_clique_reinforcements", "守 望 者 战 团 "),

  ("kingdom_4_reinforcements_a", "邦 联 炮 灰 奴 兵 团 "),
  ("kingdom_4_reinforcements_b", "邦 联 受 训 奴 兵 团 "),
  ("kingdom_4_reinforcements_c", "邦 联 着 甲 奴 兵 团 "),
  ("black_marsh_council_reinforcements_a", "迪 默 人 义 务 兵 新 兵 团 "),
  ("black_marsh_council_reinforcements_b", "迪 默 人 义 务 兵 老 兵 团 "),
  ("black_marsh_council_reinforcements_c", "迪 默 人 义 务 兵 精 英 团 "),
  ("marsh_flower_reinforcements_a", "暗 沼 之 花 廉 价 佣 兵 队 "),
  ("marsh_flower_reinforcements_b", "暗 沼 之 花 精 锐 佣 兵 队 "),
  ("offspring_of_uhr_reinforcements_a", "大 沼 鱼 人 低 阶 义 务 兵 "),
  ("offspring_of_uhr_reinforcements_b", "大 沼 鱼 人 高 阶 义 务 兵 "),
  ("purifier_reinforcements_a", "净 世 翼 军 主 力 军 团 "),
  ("purifier_reinforcements_b", "净 世 翼 军 精 锐 军 团 "),
  ("lotus_eater_reinforcements", "归 化 安 基 亚 人 义 务 兵 "),
  ("human_hunter_reinforcements", "人 类 狩 猎 者 捕 奴 团 "),

  ("kingdom_5_reinforcements_a", "圣 教 军 新 兵 军 团 "),
  ("kingdom_5_reinforcements_b", "圣 教 军 主 力 军 团 "),
  ("kingdom_5_reinforcements_c", "圣 教 军 精 锐 军 团 "),
  ("kingdom_5_reinforcements_d", "圣 教 军 预 备 军 团 "),
  ("defense_militia_reinforcements", "协 防 民 兵 团 "),
  ("remote_militia_reinforcements", "边 地 民 兵 团 "),
  ("sin_slave_legion_reinforcements", "罪 奴 辅 助 军 团 "),
  ("baptized_legion_reinforcements", "受 洗 者 辅 助 军 团 "),
  ("armed_pilgrim_reinforcements", "武 装 朝 圣 者 部 队 "),

  ("kingdom_6_reinforcements_a", "龙 树 a "),
  ("kingdom_6_reinforcements_b", "龙 树 b "),
  ("kingdom_6_reinforcements_c", "龙 树 c "),

  ("kingdom_7_reinforcements_a", "斯 塔 胡 克 商 船 武 装 "),
  ("kingdom_7_reinforcements_b", "斯 塔 胡 克 佣 兵 团 "),
  ("kingdom_7_reinforcements_c", "斯 塔 胡 克 海 军 "),
  ("party_of_tower_reinforcements", "白 塔 党 贵 族 志 愿 兵 "),
  ("starkhook_commercial_union_reinforcements_a", "斯 塔 胡 克 商 联 贵 族 寻 血 者 "),
  ("starkhook_commercial_union_reinforcements_b", "斯 塔 胡 克 商 联 精 锐 寻 血 者 "),

  ("kingdom_8_reinforcements_a", "自 由 城 邦 民 团 "),
  ("kingdom_8_reinforcements_b", "自 由 城 邦 城 防 军 "),
  ("kingdom_8_reinforcements_c", "自 由 城 邦 堡 垒 城 防 军 "),
  ...
  ("curved_fire", "曲 射 火 力 "),
  ("flat_fire", "平 射 火 力 "),
  ("strategic_strength", "战 略 力 量 "),
  ("assistance", "辅 助 "),
  ("cannon_fodder", "炮 灰 "),
  ("non_military_personnel", "非 军 事 人 员 "),
  ("monster", "敌 意 存 在 "),
...
#沙盘AI行动姿态
  ...
  ("encounter_mode_1", "单 一 部 队 作 战 "),
  ("encounter_mode_2", "多 部 队 分 别 进 场 "),
  ("encounter_mode_3", "多 部 队 合 并 进 场 "),
  ("encounter_mode_4", "多 部 队 陆 续 进 场 "),

  ("encounter_mode_1_brief", "    该 方 只 有 一 支 部 队 参 与 战 斗 ， 比 如 一 个 领 主 的 部 队 或 者 一 支 大 军 等 。 "),
  ("encounter_mode_2_brief", "    该 方 有 多 支 部 队 同 时 进 入 战 斗 ， 但 是 进 场 后 他 们 各 自 保 持 着 编 制 。 比 如 多 名 地 位 相 同 的 领 主 进 入 战 斗 ， 互 相 之 间 都 各 自 指 挥 着 自 己 的 编 队 ， 彼 此 之 间 只 有 有 限 的 配 合 。 "),
  ("encounter_mode_3_brief", "    该 方 有 多 支 部 队 同 时 进 入 战 斗 ， 并 且 在 一 个 领 导 核 心 的 指 挥 下 ， 他 们 将 部 队 打 散 统 一 整 编 到 一 起 ， 步 调 一 致 协 同 行 动 。 "),
  ("encounter_mode_4_brief", "    该 方 有 多 支 部 队 进 入 战 斗 ， 但 是 部 分 部 队 在 交 战 过 程 才 中 姗 姗 来 迟 。 可 手 动 设 置 各 部 队 分 别 在 哪 个 轮 次 进 场 。 "),

  ("campaign_brief", "    当 交 战 人 数 超 过 千 人 ， 呼 喊 已 很 难 指 挥 所 有 人 员 ； 当 人 数 超 过 万 人 ， 指 挥 官 甚 至 无 法 将 自 己 的 部 队 尽 收 眼 底 ， 只 能 依 靠 传 令 系 统 指 挥 ； 当 人 数 达 到 十 万 人 时 ， 如 果 没 有 合 理 的 指 挥 体 系 ， 友 军 之 间 甚 至 可 能 互 相 火 并 。 ^    会 战 系 统 就 是 对 这 类 大 规 模 战 争 的 模 拟 ， 作 为 大 地 图 与 进 场 作 战 中 的 一 个 中 间 层 存 在 。 进 入 会 战 沙 盘 后 ， 玩 家 和 敌 方 都 会 拆 分 为 大 量 数 百 至 数 千 人 的 编 队 ， 编 队 具 有 不 同 职 能 ， 擅 长 不 同 的 行 动 。 能 够 进 行 埋 伏 、 侦 察 、 远 程 打 击 、 建 造 工 事 、 刺 杀 等 等 一 系 列 复 杂 的 战 术 。 同 时 ， 沙 盘 上 的 区 块 也 会 提 供 不 同 的 增 益 、 减 益 、 各 种 效 果 。 ^    敌 我 双 方 编 队 进 入 同 一 区 块 后 ， 如 果 玩 家 在 该 编 队 里 ， 则 可 以 像 普 通 战 斗 一 样 进 场 领 兵 杀 敌 。 玩 家 不 在 的 编 队 ， 则 会 自 动 战 斗 。 ^    值 得 注 意 的 是 ， 大 部 分 战 斗 无 法 将 敌 人 彻 底 剿 灭 。 损 失 超 过 一 定 数 额 ， 敌 人 就 会 试 图 撤 退 ， 并 在 相 当 一 段 时 间 内 无 法 阻 拦 你 的 军 事 意 图 。 相 应 的 ， 如 果 能 将 敌 人 彻 底 围 剿 至 撤 编 ， 领 主 将 需 要 花 费 上 百 甚 至 数 百 天 才 能 恢 复 人 手 ， 为 我 方 带 来 巨 大 的 优 势 。 "),


  ("boss_description_begin", "boss_description_begin"),
  ("boss_description_1", "斯 塔 胡 克 岩 雷 狂 战 士 是 大 公 国 的 中 坚 力 量 ， 大 公 国 的 各 个 军 队 中 都 能 见 到 其 活 跃 的 身 影 ， 因 此 玩 家 在 执 行 针 对 大 公 国 的 战 场 任 务 时 ， 其 将 有 高 概 率 阻 拦 在 玩 家 面 前 。 ^^岩 雷 狂 战 士 使 用 双 手 斧 ， 威 力 巨 大 ， 玩 家 被 其 攻 击 命 中 将 受 到 重 创 ， 但 是 攻 击 距 离 并 不 长 ， 推 荐 使 用 能 够 挥 舞 的 长 杆 武 器 应 对 。 同 时 ， 岩 雷 狂 战 士 还 有 可 能 装 备 飞 斧 ， 虽 然 数 量 不 多 ， 命 中 率 和 射 程 都 不 高 ， 但 在 近 距 离 下 被 一 发 击 中 面 门 ， 还 是 非 常 致 命 的 。 ^^岩 雷 狂 战 士 会 使 用 位 移 技 能 “ 武 技 ： 血 星 冲 击 ” ， 在 远 距 离 和 玩 家 使 用 远 程 时 会 高 概 率 使 用 这 一 招 ， 瞬 间 移 动 到 玩 家 上 空 造 成 范 围 伤 害 。 在 看 到 岩 雷 狂 战 士 高 高 跃 起 时 迅 速 向 前 翻 滚 即 可 逃 出 攻 击 范 围 ， 如 果 水 平 够 高 ， 可 以 立 即 转 身 向 后 翻 滚 ， 这 样 能 得 到 一 次 攻 击 岩 雷 狂 战 士 背 部 的 机 会 。 ^^岩 雷 狂 战 士 会 使 用 “ 赤 潮 战 吼 ” 、 “ 血 涌 战 吼 ” 和 “ 血 钢 战 吼 ” 三 个 战 誓 ， 这 四 个 猩 红 系 武 技 /术 法 都 是 在 具 有 “ 状 态 ： 血 潮 汹 涌 ” 时 才 会 发 动 。 “ 状 态 ： 血 潮 汹 涌 ” 是 岩 雷 狂 战 士 的 核 心 机 制 ， 他 的 赤 潮 战 吼 和 攻 击 会 为 他 叠 加 “ 状 态 ： 血 潮 汹 涌 ” ， 同 时 当 此 状 态 过 高 时 他 会 倾 向 于 使 用 其 他 血 系 技 能 以 消 耗 “ 状 态 ： 血 潮 汹 涌 ” 。 ^^同 样 ， 赤 潮 战 吼 、 血 涌 战 号 、 以 及 狂 战 士 在 死 后 发 动 的 血 溢 ， 均 会 为 被 命 中 的 玩 家 添 加 “ 状 态 ： 血 潮 汹 涌 ” ， 一 旦 叠 满 九 层 ， 玩 家 将 直 接 倒 地 身 亡 。 如 果 玩 家 未 启 用 消 耗 “ 状 态 ： 血 潮 汹 涌 ” 的 血 系 技 能 ， 务 必 小 心 这 些 攻 击 。 ^^最 后 ， 岩 雷 狂 战 士 会 使 用 “ 武 技 ： 裂 地 猛 进 “ 和 ” 武 技 ： 野 盲 击 “ 。 武 技 不 可 打 断 ， 务 必 小 心 他 近 距 离 使 用 。 不 过 ， 武 技 使 用 后 会 形 成 一 个 比 较 大 的 硬 质 ， 正 是 玩 家 攻 击 的 时 机 。 诱 使 岩 雷 狂 战 士 使 用 武 技 并 躲 闪 反 击 ， 将 是 取 得 胜 利 的 关 键 。 "),
  ("boss_description_2", "邦 联 的 角 斗 士 们 ， 在 赌 上 性 命 的 无 尽 死 斗 中 习 得 了 精 湛 的 武 艺 ， 角 斗 冠 军 更 是 从 尸 山 血 海 中 爬 出 的 佼 佼 者 。 一 旦 近 身 ， 他 们 就 会 如 排 山 倒 海 般 猛 攻 ， 直 到 将 敌 人 完 全 击 倒 。 ^^然 而 ， 他 们 不 被 允 许 使 用 、 也 从 得 到 机 会 习 得 咏 唱 ， 同 样 的 ， 为 了 提 高 角 斗 的 观 赏 性 ， 他 们 也 不 被 允 许 使 用 投 射 物 甚 至 盾 牌 。 因 此 ， 只 要 保 持 距 离 ， 用 远 程 放 倒 他 们 ， 便 能 轻 松 赢 下 一 场 没 有 荣 耀 的 胜 利 。 "),
