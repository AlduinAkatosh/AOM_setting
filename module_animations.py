...
#  3) Animation master flags: could be anything beginning with amf_ defined in header_animations.py. If this is writen as 33554506, it means 0x02000000+0x40+0xa(16)
...
#  4.6) 
#  4.7) Displacement: (x, x, x) represents the displacement on the XYZ axis. First point is right, second is forward and third is above.
# 
####################################################################################################################
...
#Used to determine the priority of actions
amf_priority_jump           = 2                      #0x2
amf_priority_ride           = 2                        #0x2
amf_priority_continue       = 1                    #0x1
amf_priority_attack         = 10                    #0xa
amf_priority_cancel         = 12                    #0xc
amf_priority_defend         = 14                   #0xe
...
amf_priority_kick           = 33                      #0x21
amf_priority_jump_end       = 33                #0x21
amf_priority_reload         = 60                    #0x21
amf_priority_mount          = 64                   #0x3C
amf_priority_equip          = 70                     #0x46
amf_priority_rear           = 74                       #0x4A
amf_priority_striked        = 80                     #0x50
amf_priority_fall_from_horse= 81                #0x51
amf_priority_active_skill= 82                #0x51
amf_priority_die            = 95                        #0x5F
amf_priority_highest            = 99
...
#无盾上刺
 ["ready_overswing_spear", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
   [ready_durn, "attacks_staff_thrust_overhead",  6, 21, arf_blend_in_0|blend_in_walk|blend_in_continue],
 ],
 ["release_overswing_spear", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
   [0.45, "attacks_staff_thrust_overhead", 21, 43, blend_in_walk|blend_in_continue],
 ],
 ["release_overswing_spear_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
   [0.3, "attacks_staff_thrust_overhead", 43, 50, arf_blend_in_0|blend_in_continue],
 ],
 ["parried_overswing_spear", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
   [0.3, "attacks_staff_thrust_overhead", 50, 43, arf_blend_in_0|blend_in_continue],
 ],
...
#有盾上刺
 ["ready_overswing_musket", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
  [ready_durn, "1h_spear_thrust_overhead", 0, 20, arf_blend_in_0|blend_in_walk|blend_in_continue],
 ],
 ["release_overswing_musket", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
  [0.45, "1h_spear_thrust_overhead", 20, 41, blend_in_walk|blend_in_continue],
 ],
 ["release_overswing_musket_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
  [0.3, "1h_spear_thrust_overhead", 41, 52, blend_in_walk|blend_in_continue],
 ],
 ["parried_overswing_musket", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
  [attack_parried_duration, "1h_spear_thrust_overhead", 26, 22, arf_blend_in_0|blend_in_continue],
 ],
 ["blocked_overswing_musket", 0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  [attack_blocked_duration, "1h_spear_thrust_overhead", 26, 22, arf_blend_in_0|blend_in_continue],
 ],
...
#shield against
 ["shield_against", acf_enforce_all, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
   [1.3, "strike_frontal", 0, 38, arf_blend_in_3], 
 ],
 ["shield_against_bechase_1", acf_enforce_all, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
   [2, "strikes3_head", 0, 81, arf_blend_in_3], 
 ],
 ["shield_against_bechase_2", acf_enforce_all, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
   [1.6, "death_chest", 0, 38, arf_blend_in_3], #fall
 ],
...
#Ghost
["fantom_withdraw", acf_enforce_all|acf_displace_position, amf_priority_fall_from_horse|amf_play|amf_accurate_body,
   [1.7, "fantom_withdraw", 0, 55, arf_blend_in_1, 0, (0,-5,0)],
],

#inflitration
 ["stand_to_crouch_new", acf_enforce_all, amf_priority_jump|amf_accurate_body|amf_play,#蹲下
   [1.3, "crouch_down", 0, 50,  arf_blend_in_1, 0, (0.0,0,0.0)],
 ],
 ["crouch_to_stand_new", acf_enforce_all, amf_priority_jump|amf_accurate_body|amf_play,#站起
   [1.3, "crouch_down", 150, 185,  arf_blend_in_1, 0, (0.0,0,0.0)],
 ],
 ["crouch_state_new", acf_enforce_lowerbody, amf_priority_jump|amf_use_cycle_period|amf_accurate_body|amf_play, #保持蹲下
   [11.000000, "crouch_down", 50, 135, arf_use_stand_progress, 0, (0.000000, 0.000000, 0.000000), 0.250000],
 ],
 ["walk_forward_crouch_new", acf_enforce_all, amf_priority_jump|amf_use_cycle_period|amf_accurate_body|amf_play, 
   [1.700000, "low_walk", 0, 48, arf_blend_in_3|arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000), 0.400000],
 ],


#coule and rolling, code and animation come from user jj95198 and user get.shot.with.. in M&B Chinese Station.
["roll_forward", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_priority_kick|amf_play|amf_accurate_body|amf_client_prediction|amf_use_weapon_speed,
   [1.2, "qian_gun", 0, 49, blend_in_release, 0, (0,3.7133,0)],
],

["roll_backward", acf_enforce_all|acf_displace_position, amf_priority_kick|amf_play|amf_accurate_body|amf_client_prediction,
   [1.1, "jump_back", 0, 72, arf_blend_in_1, 0, (0,-2.6,0)],
],

["roll_left", acf_enforce_all|acf_displace_position, amf_priority_kick|amf_play|amf_accurate_body|amf_client_prediction,
   [1.1, "roll_left", 0, 49, arf_blend_in_1, 0, (-3.2133,0,0)],
],

["roll_right", acf_enforce_all|acf_displace_position, amf_priority_defend_parry|amf_play|amf_accurate_body|amf_client_prediction,
   [1.1, "roll_right", 0, 49, arf_blend_in_1, 0, (3.2133,0,0)],
],

["coule_left", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_priority_attack|amf_play|amf_accurate_body|amf_client_prediction|amf_use_weapon_speed,
   [1.0, "coule_left", 0, 34, blend_in_release, 0, (-3.528,0,0)],
],

["coule_right", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_priority_attack|amf_play|amf_accurate_body|amf_client_prediction|amf_use_weapon_speed,
   [1.0, "coule_right", 0, 34, blend_in_release, 0, (3.528,0,0)],
],


# ["fall_from_horse", acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_client_prediction,
#   [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3], 
# ],
...
##主动技能
#刺剑
["active_lunge", acf_enforce_all|acf_right_cut, amf_play|amf_priority_active_skill, 
[1.6, "tiaozhang", 0, 27, blend_in_walk|blend_in_continue],
],
["active_double_lunge", acf_enforce_all|acf_right_cut, amf_play|amf_priority_active_skill, 
[1.8, "tiaozhang02", 0, 28, blend_in_walk|blend_in_continue],
],

#旋刃斩
["active_sweep_away", acf_enforce_all|acf_right_cut, amf_play|amf_priority_active_skill, 
[1.6, "parry_attack_slashleft_onehanded_y", 21, 43, blend_in_walk|blend_in_continue],
],

#跳劈
["active_leap_attack", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill, 
[1.4, "tiaozhang", 27, 48, blend_in_walk|blend_in_continue, 0, (0, 3.5, 0), 0.0],
],

#横扫
["active_thump", acf_enforce_all|acf_right_cut, amf_play|amf_priority_active_skill, 
[2.1, "attacks_staff_righttoleft_y2", 0, 58, blend_in_walk|blend_in_continue],
],

#撩剑
["active_curve_sword", acf_enforce_all|acf_right_cut, amf_play|amf_priority_active_skill, 
[1.8, "liaojian", 0, 79, blend_in_walk|blend_in_continue],
],

#刃旋舞
["active_double_slant_slash", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill, 
[2.1, "xuanfengzhan", 0, 56, blend_in_walk|blend_in_continue, 0, (-0.35, 1.3, 0), 0.0],
],

#盲击
["active_casual_attack", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill, 
[3.3, "one_hand_attack_1", 0, 100, blend_in_walk|blend_in_continue, 0, (0, 2, 0), 0.0],
],
["active_heavy_casual_attack", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill, 
[3.1, "two_hand_attack_3", 0, 100, blend_in_walk|blend_in_continue, 0, (0, 4.1, 0), 0.0],
],

#重跃斩
["active_heavy_jump_chop", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill, 
[1.8, "two_hand_attack_1", 0, 60, blend_in_walk|blend_in_continue, 0, (0, 3.9, 0), 0.0],
],

#重旋斩
["active_heavy_spin_chop", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill, 
[1.7, "two_hand_attack_2", 0, 55, blend_in_walk|blend_in_continue, 0, (0, 3.6, 0), 0.0],
],

#裂地猛进
["active_earthsplitting_charge", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill, 
[1.2, "earthsplitting_charge", 0, 69, blend_in_walk|blend_in_continue, 0, (0, 3.2, 0), 0.0],
],
#掀地
["active_ground_heaving", acf_enforce_all|acf_right_cut, amf_play|amf_priority_active_skill,
[2.0, "ground_heaving", 0, 35, blend_in_walk|blend_in_continue],
],

#旋击斩
["active_spinning_slash_simple", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill, 
[1.5, "one_hand_attack_2", 0, 35, blend_in_walk|blend_in_continue, 0, (0, 3.2, 0), 0.0],
],
["active_spinning_assault_slash", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill, 
[1.3, "defensive_spinning_slash", 0, 32, blend_in_walk|blend_in_continue, 0, (0.1639, 2.879, 0), 0.0],
],
["active_spinning_defense_slash", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill, 
[1.3, "backward_spinning_slash", 0, 32, blend_in_walk|blend_in_continue, 0, (0.1639, -3.5, 0), 0.0],
],

#潜身斩
["active_undercover_slash", acf_right_cut|acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[1.2, "undercover_slash", 0, 64, blend_in_walk|blend_in_continue],
],

#战争践踏
["active_war_stomp", acf_enforce_all|acf_ignore_slope, amf_accurate_body|amf_play|amf_priority_active_skill|amf_start_instantly, 
[4.0, "horse_stomp", 0, 49, arf_blend_in_8],
],
["active_war_stomp_rider", acf_enforce_all|acf_ignore_slope, amf_accurate_body|amf_play|amf_priority_active_skill, 
[4.0, "horse_stomp_rider", 0, 49, blend_in_walk|blend_in_continue],
],

#银落
["active_silver_fall", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[5.0, "silver_fall", 0, 62, blend_in_walk|blend_in_continue],
],
["active_silver_fall_rider", acf_right_cut|acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[5.0, "silver_fall_rider", 0, 62, blend_in_walk|blend_in_continue],
],

#左手还击
["left_hand_counterattack", acf_left_cut|acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[0.7, "defend_shield_parry_all", 12, 30, blend_in_walk|blend_in_continue],
],

#左手反箭术准备动作
["left_hand_block_arrow_prepare", acf_left_cut|acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[1.4, "left_hand_block_arrow", 3, 61, blend_in_walk|blend_in_continue],
],
#左手反箭术
["left_hand_block_arrow", acf_left_cut|acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[0.2, "left_hand_block_arrow", 3, 9, blend_in_walk|blend_in_continue],
[0.2, "left_hand_block_arrow", 9, 16, blend_in_walk|blend_in_continue],
[0.2, "left_hand_block_arrow", 16, 23, blend_in_walk|blend_in_continue],
[0.2, "left_hand_block_arrow", 23, 30, blend_in_walk|blend_in_continue],
[0.2, "left_hand_block_arrow", 30, 37, blend_in_walk|blend_in_continue],
[0.2, "left_hand_block_arrow", 37, 43, blend_in_walk|blend_in_continue],
[0.2, "left_hand_block_arrow", 43, 48, blend_in_walk|blend_in_continue],
[0.2, "left_hand_block_arrow", 48, 55, blend_in_walk|blend_in_continue],
[0.2, "left_hand_block_arrow", 55, 61, blend_in_walk|blend_in_continue],
],

#拉满弓
["active_power_shot", acf_rot_vertical_bow|acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[2.0, "power_shot", 0, 29, blend_in_walk|blend_in_continue],
],
#三连射
["active_continuous_shot", acf_rot_vertical_bow|acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[2.9, "continuous_shot", 0, 41, blend_in_walk|blend_in_continue],
],
#多重箭
["active_multiple_arrow", acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill, 
[3.0, "multiple_arrow", 0, 43, blend_in_walk|blend_in_continue, 0, (0, -5.6, 0), 0.0],
],
#武技：投箭
["active_throwing_arrow", acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill, 
[1.5, "throwing_arrow", 0, 29, blend_in_walk|blend_in_continue, 0, (0.3, -3.0, 0), 0.0],
],


#割喉
["active_cutthroat_prepare", acf_right_cut|acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[1.0, "cutthroat_prepare", 0, 13, blend_in_walk|blend_in_continue],
],
["active_cutthroat_1", acf_right_cut|acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[2.5, "cutthroat_1", 0, 31, blend_in_walk|blend_in_continue],
],
["active_cutthroat_2", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[2.5, "cutthroat_2", 0, 31, blend_in_walk|blend_in_continue],
],


#释放毒雾
["active_release_toxin_fog", acf_right_cut|acf_rot_vertical_bow|acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill, 
[4.2, "release_toxin_fog", 0, 41, blend_in_walk|blend_in_continue, 0, (0.15, 2.3, 0), 0.0],
],

#火焰横扫
["active_flame_sweep", acf_left_cut|acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[2.7, "flame_sweep", 0, 27, blend_in_walk|blend_in_continue],
],

#血星冲击
["active_blood_strike", acf_right_cut|acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[2.6, "bloodstrike", 0, 42, blend_in_walk|blend_in_continue],
],

#发动咏唱的动作（以免开始咏唱了却没有任何指示）
["chant_short", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[0.8, "chant_short", 0, 24, arf_blend_in_0],
],
["chant_long", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[1.6, "chant_long", 0, 33, arf_blend_in_0],
],

#盾类神术
["active_pray_shield", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[2.5, "pray_shield", 0, 65, arf_blend_in_0],
],

#唤来血雨的战歌
["active_warcy_bloodrain", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill, 
[4.5, "warcy_bloodrain", 0, 66, blend_in_walk|blend_in_continue, 0, (0, 0, 0), 0.0],
],

#附魔
["active_enchant_1", acf_enforce_all|acf_left_cut, amf_accurate_body|amf_play|amf_priority_active_skill, 
[2.8, "enchant_anim_1", 0, 49, blend_in_walk|blend_in_continue, 0, (0, 0, 0), 0.0],
],

#引燃炎锋
["active_enchant_2", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[3.5, "enchant_anim_2", 0, 41, arf_blend_in_0],
],

["active_enchant_3", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[1.1, "enchant_anim_3", 0, 28, arf_blend_in_0],
],

["active_enchant_5", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[1.1, "enchant_anim_5", 0, 19, arf_blend_in_0],
],

["active_enchant_6", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[1.3, "enchant_anim_6", 0, 32, arf_blend_in_0],
],

["active_enchant_7", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[1.0, "enchant_anim_7", 0, 19, arf_blend_in_0],
],

["active_enchant_8", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[1.0, "enchant_anim_8", 0, 13, arf_blend_in_0],
],

#下指令
["command_anim_1", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[1.5, "command_anim_1", 0, 36, arf_blend_in_0],
],
["command_anim_2", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[2.5, "command_anim_2", 0, 41, arf_blend_in_0],
],

#用于动画的动作
["cheer_new", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[3.5, "enchant_anim_2", 0, 41, arf_blend_in_0],
],

 ["crazy_continuous_chopping", acf_enforce_all, amf_client_owner_prediction|amf_play|amf_priority_attack|amf_keep,
   [3, "attacks_twohanded_overswing", 0, 73, arf_cyclic],
 ],

 ["standard_twohand_stand", acf_enforce_all, amf_client_owner_prediction|amf_play|amf_priority_attack|amf_keep,
   [3, "standard_slashright_twohanded", 62, 79, 0],
 ],

 ["dead_body", acf_enforce_all, amf_play|amf_keep|amf_priority_highest, 
   [0.1, "death_chest", 37, 38, 0],
 ],


#序章船上战斗
["ship_attacked_pos_1", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[3.5, "ship_attacked_pos_1", 0, 36, arf_blend_in_0],
],
["ship_attacked_pos_2", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill|amf_keep,
[3, "ship_attacked_pos_2", 0, 12, arf_blend_in_0],
],
["ship_attacked_pos_3", acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill,
[3, "ship_attacked_pos_3", 0, 32, blend_in_walk|arf_make_walk_sound, 0, (0, 1, 0), 0.0],
],
["ship_attacked_pos_4", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill|amf_keep,
[0.5, "ship_attacked_pos_4", 0, 9, arf_blend_in_0],
],
["ship_attacked_pos_5", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill|amf_keep,
[6, "ship_attacked_pos_5", 0, 81, arf_blend_in_0],
],
#序章走私码头潜行
["smuggle_wharf_infliation_1", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[4, "smuggle_wharf_infliation_1", 0, 13, arf_blend_in_0],
],
#序章勒塞夫街头
["lesaff_square_pos_1", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill|amf_keep,
[3, "lesaff_square_pos_1", 0, 6, arf_blend_in_0],
],
["lesaff_square_pos_1_b", acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill,
[1, "lesaff_square_pos_1", 6, 13, blend_in_walk|arf_make_walk_sound, 0, (0, 0.2, 0), 0.0],
],
["lesaff_square_pos_2", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill|amf_keep,
[3, "lesaff_square_pos_2", 0, 20, arf_blend_in_0|arf_cyclic],
],
["lesaff_square_pos_3", acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill,
[3, "lesaff_square_pos_3", 0, 13, blend_in_walk|arf_make_walk_sound, 0, (0, -1, 0), 0.0],
],
["lesaff_square_pos_4", acf_enforce_all|acf_displace_position|acf_anim_length(100), amf_accurate_body|amf_play|amf_priority_active_skill,
[8, "lesaff_square_pos_4", 0, 45, blend_in_walk|arf_make_walk_sound, 0, (1, -0.1, 0), 0.0],
],
["lesaff_square_pos_5", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill|amf_keep,
[4, "lesaff_square_pos_5", 0, 34, blend_in_walk],
],
["lesaff_square_pos_6", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill|amf_keep,
[3, "lesaff_square_pos_6", 0, 13, blend_in_walk],
],
#序章权厄之秤据点
["lesaff_underworld_stronghold_1", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill|amf_keep,
[8, "lesaff_underworld_stronghold_1", 0, 12, arf_blend_in_0|arf_cyclic],
],


#冠军拍卖支线
["champion_auction_pos_1", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill|amf_keep,
[8, "champion_auction_pos_1", 0, 12, arf_blend_in_0|arf_cyclic],
[8, "champion_auction_pos_2", 0, 12, arf_blend_in_0|arf_cyclic],
[8, "champion_auction_pos_3", 0, 12, arf_blend_in_0|arf_cyclic],
[8, "champion_auction_pos_4", 0, 12, arf_blend_in_0|arf_cyclic],
],


#第三个死支线
["third_death_pos_1", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[3, "third_death_pos_1", 0, 22, arf_blend_in_0],
],
["third_death_pos_2_1", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill|amf_keep,
[2, "third_death_pos_2", 0, 2, arf_blend_in_0],
],
["third_death_pos_2_2", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[1.4, "third_death_pos_2", 0, 14, arf_blend_in_0],
],



 ["powerhouse_position_1", acf_enforce_all, amf_client_owner_prediction|amf_play|amf_priority_die|amf_keep,
   [3, "powerhouse_position_1", 0, 7, arf_cyclic],
 ],
 ["powerhouse_position_2", acf_enforce_all, amf_client_owner_prediction|amf_play|amf_priority_die|amf_keep,
   [6, "powerhouse_position_2", 0, 10, arf_cyclic],
 ],
 ["powerhouse_position_3", acf_enforce_all, amf_client_owner_prediction|amf_play|amf_priority_die|amf_keep,
   [6, "powerhouse_position_3", 0, 10, arf_cyclic],
 ],
 ["powerhouse_position_4", acf_enforce_all, amf_client_owner_prediction|amf_play|amf_priority_die|amf_keep,
   [6, "powerhouse_position_4", 0, 10, arf_cyclic],
 ],
 ["powerhouse_position_5", acf_enforce_all, amf_client_owner_prediction|amf_play|amf_priority_die|amf_keep,
   [6, "powerhouse_position_5", 0, 10, arf_cyclic],
 ],
 ["powerhouse_position_6", acf_enforce_all, amf_client_owner_prediction|amf_play|amf_priority_die|amf_keep,
   [6, "powerhouse_position_6", 0, 10, arf_cyclic],
 ],
 ["powerhouse_position_7", acf_enforce_all, amf_client_owner_prediction|amf_play|amf_priority_die|amf_keep,
   [6, "powerhouse_position_7", 0, 10, arf_cyclic],
 ],
 ["powerhouse_position_8", acf_enforce_all, amf_client_owner_prediction|amf_play|amf_priority_die|amf_keep,
   [6, "powerhouse_position_8", 0, 17, arf_cyclic],
 ],
 ["powerhouse_position_9", acf_enforce_all, amf_client_owner_prediction|amf_play|amf_priority_die|amf_keep,
   [6, "powerhouse_position_9", 0, 17, arf_cyclic],
 ],



#骷髅爬出
 ["active_skeleton_rebirth_1", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[4.5, "skeleton_rebirth_1", 0, 43, arf_blend_in_0],
],
 ["active_skeleton_rebirth_2", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
[4.8, "skeleton_rebirth_2", 0, 39, arf_blend_in_0],
],

 ["active_skeleton_horse_rebirth", acf_enforce_all, amf_accurate_body|amf_play|amf_priority_active_skill,
   [4.8, "skeleton_horse_rebirth", 0, 56, arf_blend_in_0],
 ],
