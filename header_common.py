...
#征兵制的注册
###################################################
rsm_professional = 0 #职业士兵制
rsm_conscriptive = 1 #征召士兵制
rsm_mercenary = 2 #雇佣士兵制
rsm_tribe = 3 #部落士兵制
rsm_elite = 4 #精兵制
...
#随机事件的注册
###################################################
event_default = 1 #无事发生
event_find_hidden_place = 2 #发现隐藏场所

event_encountered_pickpocket = 3 #遭遇扒手
event_encountered_robbery = 4 #遭遇抢劫
event_assassination = 5 #遇到刺杀

event_recruit_noble = 6 #招募贵族子弟
event_recruit_citizen = 7 #招募市民
event_recruit_refugee = 8 #招募难民

event_commercial_information = 9 #偷听商业信息
event_found_wallet = 10 #捡到钱包

event_bookcollector = 11 #藏书家抛售书籍
event_visit_master = 12 #拜访大师

event_slave_trader = 13 #奴隶贩子贩卖奴隶
event_ransom_broker = 14 #赎金经纪人贩卖士兵

event_small_competition = 15 #小型挑战赛
event_dragon_blood_merchant = 16 #龙血商人

event_discover_scandal_1 = 17 #发现丑闻一
event_discover_scandal_2 = 18 #发现丑闻二

event_noble_beat_servant = 19 #贵族殴打仆人
event_noble_assassinated = 20 #贵族遭遇刺杀

event_street_singing = 21 #街头卖唱
event_handling_expired_food = 22 #商家处理临期产品

event_beggar_begging = 23 #乞丐乞讨
event_discover_orphanage = 24 #发现孤儿院

event_find_stolen_goods = 25 #找到赃物
