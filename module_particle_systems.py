...
##### Dungeon Water Drops  END #####
    ...
    ("sword_fire", psf_always_emit|psf_global_emit_dir|psf_billboard_3d|psf_randomize_rotation|psf_randomize_size, "prt_mesh_fire_1",
     550, 0.35, 0.2, 0.03, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 0.8), (1, 0),        #alpha keys
     (0.5, 1.0), (1.0, 0.9),      #red keys
     (0.5, 0.7), (1.0, 0.3),       #green keys
     (0.5, 0.2), (1.0, 0.0),      #blue keys
     (0.0, 0.05), (0.3, 0.2),   #scale keys
     (0.02, 0.56, 0.02),      #emit box size
     (0, 0, 0.02),               #emit velocity
     0.0,                       #emit dir randomness
     200,                       #rotation speed
     0.5                        #rotation damping
    ),

    ("sword_magic_fire_1", psf_always_emit|psf_global_emit_dir|psf_billboard_3d|psf_randomize_rotation|psf_randomize_size, "prt_mesh_fire_1",
     550, 1, 0.02, -0.05, 150.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 0.8), (1, 1),        #alpha keys
     (0, 1.00), (1.0, 0.8),      #red keys
     (0, 1.00), (1.0, 0.8),       #green keys
     (0, 1.00), (1.0, 0.8),      #blue keys
     (0, 0.05), (1.0, 0.2),   #scale keys
     (0.04, 0.75, 0.1),      #emit box size
     (0, 0, 0.02),               #emit velocity
     0.0,                       #emit dir randomness
     200,                       #rotation speed
     0.5                        #rotation damping
    ),
    ("sword_magic_fire_2", psf_always_emit|psf_global_emit_dir|psf_billboard_3d|psf_randomize_rotation|psf_randomize_size, "prt_mesh_fire_1",
     550, 1, 0.02, -0.05, 150.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 0.8), (1, 1),        #alpha keys
     (0, 0.35), (1.0, 0),      #red keys
     (0, 0.14), (1.0, 0),       #green keys
     (0, 0.39), (1.0, 0),      #blue keys
     (0, 0.16), (1.0, 0.02),   #scale keys
     (0.04, 0.75, 0.1),      #emit box size
     (0, 0, 0.02),               #emit velocity
     0.0,                       #emit dir randomness
     200,                       #rotation speed
    ...
    ("blood_rain", psf_always_emit|psf_global_emit_dir|psf_billboard_2d, "prtcl_rain",#血雨
     1000, 0.5, 0.33, 1.0, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (1.0, 0.3), (1, 0.3),        #alpha keys
     (1.0, 1.0), (1, 1.0),      #red keys
     (1.0, 0.0), (1, 0.0),      #green keys
     (1.0, 0.0), (1, 0.0),      #blue keys
     (1.0, 1.0),   (1.0, 1.0),   #scale keys
     (4.2, 4.2, 10.2),           #emit box size
     (0, 0, -10.0),               #emit velocity
     0.0,                       #emit dir randomness
     0,                       #rotation speed
     0.5                        #rotation damping
    ...
    ("blood_splash", psf_always_emit|psf_global_emit_dir|psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "prt_mesh_dust_1",#血烟
     100, 4.0, 0.7, 0.2, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 0.8), (1, 0.7),        #alpha keys
     (0, 1.0), (1, 1.0),      #red keys
     (0, 0.0), (1, 0.0),      #green keys
     (0, 0.0), (1, 0.0),      #blue keys
     (0, 6),   (1.0, 8),   #scale keys
     (0.2, 0.2, 0.1),           #emit box size
     (0, 0, 0.1),               #emit velocity
    ...
    ("normal_splash", psf_always_emit|psf_global_emit_dir|psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "prt_mesh_dust_1",#普通烟
     100, 4.0, 0.7, 0.2, 10, 0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.8), (1, 0.7),        #alpha keys
    ...
    ("spectre_burst", psf_always_emit|psf_global_emit_dir|psf_billboard_3d|psf_randomize_rotation,  "barf_skull_ghost",#灵爆
     15, 4, 0, 0, 10, 2,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 1), (1, 1),          #alpha keys
     (0.1, 1), (1, 1),      #red keys
     (0.1, 1),(1, 1),       #green keys
     (0.1, 1), (1, 1),      #blue keys
     (0.0, 1),   (1, 1),    #scale keys
     (0.2, 0.2, 0.5),           #emit box size
     (3, 0, 0),                 #emit velocity
    ...
    ("ghost_smoke", psf_global_emit_dir|psf_always_emit|psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "prt_mesh_smoke_1",#不死者的烟雾
     100, 2, 1, 0.1, 50.0, 10.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 1), (1, 1),        #alpha keys
     (0.2, 0.4), (1, 0.2),      #red keys
     (0.2, 0.4),(1, 0.2),       #green keys
     (0.2, 0.4), (1, 0.2),      #blue keys
     (0, 6),   (1, 8),          #scale keys
     (0.6, 0.6, 0.3),           #emit box size
     (0, 0, 0.2),               #emit velocity
     0,                       #emit dir randomness
     0,                       #rotation speed
     0.1                        #rotation damping
    ...
    ("history_mist_white", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_smoke_1",#历史迷雾
     10, 1, 0.2, 0, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 1), (1, 1),        #alpha keys
     (0.2, 0.4), (1, 0.2),      #red keys
     (0.2, 0.4),(1, 0.2),       #green keys
     (0.2, 0.4), (1, 0.2),      #blue keys
     (0, 0.5),   (0.4, 0.8),   #scale keys
    ...
    ("history_mist_black", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_dust_1",#历史迷雾
     10, 1, 0.2, 0, 10.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 1), (1, 1),        #alpha keys
     (0, 0.0), (1, 0.0),      #red keys
     (0, 0.0), (1, 0.0),      #green keys
    ...
    ("toxin_fog", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_smoke_1",#毒雾
     100, 1, 0.2, 0.1, 50.0, 1.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 1), (1, 1),        #alpha keys
     (0, 0.0), (1, 0.0),      #red keys
     (0, 0.7), (1, 0.3),      #green keys
     (0, 0.0), (1, 0.0),      #blue keys
     (0, 2),   (1, 4),   #scale keys
     (0.3, 0.3, 0.3),      #emit box size
     (0, 0, 0.2),               #emit velocity
     1.6,                       #emit dir randomness
     0,                       #rotation speed
     0                        #rotation damping
    ),
]
