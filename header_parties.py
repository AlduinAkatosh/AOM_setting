...
#会战沙盘AI：部队姿态
#用来控制部队移动方式的倾向
ai_attitude_none            = 0 #无姿态
ai_attitude_charge            = 1 #冲锋，向着敌方积分更高的地方去
ai_attitude_rout            = 2 #溃逃，向着敌方积分更低的地方去
ai_attitude_harass            = 3 #牵制，与最近的敌人保持在射程之内
ai_attitude_guard            = 4 #守卫，向着敌方积分更高的地方去，同时与最近的友军保持较近距离
ai_attitude_evade            = 5 #回避，向着敌方积分更低的地方去，同时与最近的友军保持较近距离
ai_attitude_selfprotect            = 6 #自我保护，向着友军积分更高的地方去
