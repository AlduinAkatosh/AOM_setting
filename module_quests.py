...
##     ),
 ...
 ("substitute_homework", "Substitute homework", qf_random_quest,
  "Substitute homework"
  ),

 ("books_reading_help", "Books Reading Help", qf_random_quest,
  "Books Reading Help"
  ),

 ("send_a_message", "Send A Message", qf_random_quest,
  "Send A Message"
  ),

 ("cemetery_travel", "Cemetery Travel", qf_random_quest,
  "Cemetery Travel"
  ),

 ("takeout_specialist", "Takeout Specialist", qf_random_quest,
  "Takeout Specialist"
  ),

 ("undead_test", "Undead Test", qf_random_quest,
  "Undead Test"
  ),

 ("escort_necromancer", "Escort Necromancer", qf_random_quest,
  "Escort Necromancer"
  ),

 ("urge_learning", "Urge Learning", qf_random_quest,
  "Urge Learning"
  ),

 ("destroy_results", "Destroy results", qf_random_quest,
  "Destroy results"
  ),

 ("retrieve_materials", "Retrieve Materials", qf_random_quest,
  "Retrieve Materials"
  ),

 ("solve_the_patrol", "Solve The Patrol", qf_random_quest,
  "Solve The Patrol"
  ),

 ("bring_disaster", "Bring Disaster", qf_random_quest,
  "Bring Disaster"
  ),

 ("acquisition_of_resources", "Acquisition Of Resources", qf_random_quest,
  "Acquisition Of Resources"
  ),

 ("upgrade_of_necromancer", "Choose A Teacher", 0,
  "Choose A Teacher"
  ),
...
#########################################################新主线剧情###################################################
##
 ("game_start_quest", "Game Start Quest", 0,#开局
  "{!}placeholder"
  ),



 ("champion_auction", "Champion Auction", 0,#支线：冠军拍卖
  "Champion Auction"
  ),
 ("third_death", "Third Death", 0,#支线：第三个死
  "Third Death"
  ),
